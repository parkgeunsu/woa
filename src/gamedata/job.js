...
export const job = [
  ...
  {idx:1,
    ...
    skill:{//단검,검,한손둔기,보조,
      ...
      lv2:[35,[36,37,38,39]],
      lv3:[[11,12,13,14]],
      maxLv:[0,1,2,35,[36,37,38,39],[11,12,13,14]],
    },
    drop:{
      gold:100,
      hole:[],
  ...
  {idx:13,
    ...
    skill:{//단검,검,양손검,둔기,창,도끼,활,타격,방패,
      ...
      lv2:[25,33,34,35],
      lv3:[11,50],
      maxLv:[0,1,2,11,15,16,33,34,35,50],
    },
    drop:{
      gold:100,
      hole:[],
...
// * 0군주 - 빛의정령, 어둠의정령
// * 1마법사 - (불의정령, 물의정령, 바람의정령, 땅의정령 중 3가지 종류만 제공) 랜덤선택,
// * 2기사 -
// * 3무사 -
// * 4학자 -
// * 5닌자 - 어둠의정령
