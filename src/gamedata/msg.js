export const msg = {
	...
	moveEvent:{
		...
		eventText0_1:{
			ko:'몬스터가 광폭화단계에 돌입합니다.',
			en:'The monster enters the berserk phase.',
			jp:'モンスターが広幅化段階に突入します。',
		},
		eventText0_2:{
			ko:'몬스터를 살려 보냈습니다.',
			en:'I sent the monster back alive.',
			jp:'モンスターを生かした。',
		},
		eventText0_3:{
			ko:'몬스터에게 붙잡혔습니다.',
			en:'I was captured by the monster.',
			jp:'モンスターに捕まった。',
		},
		eventText1:{
			ko:'강력한 몬스터를 만났습니다.',
			en:'I met a powerful monster.',
			jp:'強敵に会いました。',
		},
		eventText1_1:{
			ko:'강력한 몬스터에게 붙잡혔습니다.',
			en:'I was caught by a powerful monster.',
			jp:'強敵に捕まった。',
		},
		eventText2:{
			ko:'금화를 발견했습니다.',
			en:'I found a gold coin.',
			jp:'金貨を発見しました。。',
		},
		eventText3:{
			ko:'보물을 발견했습니다.',
			en:'I found a treasure.',
			jp:'宝を見つけました。',
		},
		eventText4:{
			ko:'성배를 발견했습니다.',
			en:'I found the Holy Grail.',
			jp:'聖杯を見つけました。',
		},
		eventText5:{
			ko:'함정을 발견했습니다.',
		...
		eventText5_1:{
			ko:'함정을 제거했습니다.',
			en:'I removed the trap.',
			jp:'トラップを削除しました。',
		},
		eventText5_2:{
			ko:'함정을 제거를 실패했습니다.',
			en:'I failed to remove the trap.',
			jp:'トラップを削除できませんでした。',
		},
		eventText6:{
			ko:'순간이동 통로를 발견했습니다.',
			en:'I found a teleportation passage.',
			jp:'瞬間移​​動通路を発見しました。',
		},
		eventText7:{
			ko:'우물을 발견했습니다.',
		...
		eventText8:{
			ko:'성스러운 우물을 발견했습니다.',
			en:'I found a sacred well.',
			jp:'神聖な井戸を発見しました。',
		},
		eventText9:{
			ko:'생명의 우물을 발견했습니다.',
			en:'I found a well of life.',
			jp:'命の井戸を発見しました。',
		},
		eventText10:{
			ko:'민가를 발견했습니다.',
			en:'I found a folk house.',
			jp:'民家を見つけました。',
		},
		eventText10_1:{
			ko:'민가가 비어있습니다.',
	...
	sentence:{
		...
		enterIDSubmit:{
			ko:'아이디를 입력후 확인을 눌러주세요.',
			en:'Enter your ID and press Confirm.',
			jp:'IDを入力後、OKを押してください。',
		},
		selectCards:{
			ko:'시작카드를 선택하세요.',
			en:'Select your startup card.',
			jp:'スタートカードを選択してください。',
		},
		selectCountry:{
			ko:'국가를 선택하세요.',
		...
		sumitId0:{
			ko:'사용 가능한 아이디입니다.',
			en:'Available usernames.',
			jp:'使用可能なIDです。',
		},
		sumitId1:{
			ko:'아이디 입력이 확인되었습니다.',
			en:'Your username has been confirmed.',
			jp:'ID入力が確認されました。',
		},
		sumitId2:{
			ko:'아이디가 저장되었습니다.',
