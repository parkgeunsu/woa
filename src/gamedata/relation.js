...
//member 활성화 조건인물 0없음
//limit 최소 인원 0없음
//eff type(효과 dmg_type&buff_type) 체력(HP)(0), 행동SP(1), 행동회복(RSP)(2), 물리 공격(ATK)(3), 물리 방어(DEF)(4), 술법 공격(MATK)(5), 술법 방어(MDEF)(6), 회복(RCV)(7), 속도(SPD)(8), 찌르기(10),할퀴기(11),물기(12),치기(13),누르기(14), 명(20),암(21),수(22),화(23),풍(24),지(25), 진형(100)
