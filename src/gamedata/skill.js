...
// 돌던지기(땅)●, 모래뿌리기(땅), 눈덩이던지기(수)●, 침뱉기(수, 광)●,
// [온천반신욕(일본원숭이한정)],
...
// 뿔찌르기(쪼기), 돌진3(광역, 치기)●, 머리박치기(치기), 발구르기(광역, 땅), 짓밟기2(누르기), 추격하기2(반격기)●,
...
// 누르기, 던지기
// 몸집 키우기(buff)●, 포효(속도 debuff), 
// 돌진3(광역,치기)●, 무거운한방(광역,누르기)●, 가변운두방(광역,누르기)●, 발구르기(광역, 땅), 돌던지기(땅)●, 바위던지기(광역,땅)●, 물대포(광역,수)●, 깔아뭉개기(광역,누르기), 땅울림(땅,광), 꼬리치기(치기), 짓밟기2(누르기)
...
// 쪼기, 물기
// 가속2(buff), 
// 손톱&뿔 갈기●, 낙석(땅), 날개치기1(바람), 고공낙하(광역, 바람), 치유의 노래(회복, 광역), 공중부양(회피)
...
// 혓바닥공격(치기), 허물벗기(회복), 꼬리자르기(회피), 삼키기(독, 단일)●
// 위장술(카멜레온한정), 
...
// 치기
// 뒷발차기1(치기)●, 개구리 기우제(날씨변경), 음파공격(광역, 빛), 혓바닥공격(치기), 고드름던지기(수), 점프(회피), 물기(물기)
