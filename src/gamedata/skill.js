export const skill = [
	...
	{idx:2,
		...
		ta_:0,ta:[23,23,23,23,23],effAnimation:'',effAnimationRepeat:1,effSize:[1,1,1,1,1],effRotate:0,effFilter:'',
		attackEff:[],multiplesAttack:[],
		buff:[{type:4,num:['100%','110%','125%','135%','150%']}],atkCount:[1],sp:0},
	{idx:3,
	...
	{idx:212,
		na:{ko:'강아지의 충성스런 용기',en:'Dog\'s Loyal Courage',jp:'愛犬の忠実な勇気'},element_type:0,cate:2,
		txt:'<area>, <buff>',
		ta_:0,ta:[23,23,23,23,23],effAnimation:'',effAnimationRepeat:1,effSize:[1,1,1,1,1],effRotate:0,effFilter:'',
		attackEff:[],multiplesAttack:[],
		buff:[{type:1,num:['5','10','15','20','25']}],atkCount:[1],sp:0},
	{idx:213,
	...
	{idx:221,
		...
		buff:[{type:5,num:['10%','20%','30%','40%','50%']}],atkCount:[1],sp:0},
	{idx:222,
		na:{ko:'곰의 우렁찬 포효',en:'Bear\'s Roar',jp:'クマの雄たけび'},element_type:0,cate:2,
		txt:'<area>, <buff>',
		ta_:0,ta:[23,23,23,23,23],effAnimation:'',effAnimationRepeat:1,effSize:[1,1,1,1,1],effRotate:0,effFilter:'',
		attackEff:[],multiplesAttack:[],
		buff:[{type:5,num:['10%','20%','30%','40%','50%']}],atkCount:[1],sp:0},
	...
	{idx:237,
		...
		attackEff:[],multiplesAttack:[],
		buff:[{type:4,num:['10%','20%','30%','40%','50%']},{type:4,num:['10%','20%','30%','40%','50%']}],buffCount:[3,3,3,3,3],atkCount:[0],sp:8},
	{idx:238,
	...
	{idx:242,
		...
		attackEff:[],multiplesAttack:[],
		eff:[{type:3,num:['120%','130%','140%','150%','160%']}],atkCount:[1],sp:14},
	{idx:243,
	...
	{idx:252,
		...
		txt:'<area>, <dmg>, <el>, <chance> <turn> <buff>',
		ta_:1,ta:[2,2,2,2,2],effAnimation:'hit4',effAnimationRepeat:1,effSize:[1.5,1.75,2,2.25,2.5],effRotate:0,effFilter:'hue-rotate(180deg)',
		attackEff:[],multiplesAttack:[],
		eff:[{type:3,num:['120%','140%','160%','180%','200%']}],buff:[{type:54,num:[]}],buffCount:[3,3,3,3,3],buffChance:['5%','7%','10%','15%','20%'],atkCount:[1],sp:12},
	{idx:253,
		na:{ko:'뒷발차기2',en:'Back Kick2',jp:'後ろ足蹴り2'},element_type:4,cate:7,
		txt:'<area>, <dmg>, <el>, <chance> <turn> <buff>',
		ta_:1,ta:[2,2,2,2,2],effAnimation:'hit4',effAnimationRepeat:1,effSize:[1.5,1.75,2,2.25,2.5],effRotate:0,effFilter:'',
		attackEff:[],multiplesAttack:[],
		eff:[{type:3,num:['130%','150%','170%','190%','230%']}],buff:[{type:54,num:[]}],buffCount:[3,3,3,3,3],buffChance:['5%','7%','10%','15%','20%'],atkCount:[1],sp:14},
	{idx:254,
		na:{ko:'뒷발차기3',en:'Back Kick3',jp:'後ろ足蹴り3'},element_type:4,cate:7,
		txt:'<area>, <dmg>, <el>, <chance> <turn> <buff>',
		ta_:1,ta:[3,3,3,3,3],effAnimation:'hit4',effAnimationRepeat:1,effSize:[1.5,1.75,2,2.25,2.5],effRotate:0,effFilter:'hue-rotate(90deg)',
		attackEff:[],multiplesAttack:[],
		eff:[{type:3,num:['150%','170%','190%','220%','250%']}],buff:[{type:54,num:[]}],buffCount:[3,3,3,3,3],buffChance:['5%','7%','10%','15%','20%'],atkCount:[1],sp:16},
	{idx:255,
	...
	{idx:256,
		...
		attackEff:[],multiplesAttack:[],
		eff:[{type:3,num:['50%','60%','70%','80%','100%']}],buff:[{type:51,num:['5%','5%','5%','5%','5%']}],buffCount:[2,2,3,3,3],buffChance:['25%','35%','50%','65%','80%'],atkCount:[1],sp:15},
	{idx:257,
		...
		attackEff:[],multiplesAttack:[],
		eff:[{type:3,num:['110%','120%','140%','150%','170%']}],buff:[{type:56,num:[]}],buffCount:[],buffChance:['1%','2%','3%','4%','5%'],atkCount:[1],sp:20},
	{idx:258,
		...
		attackEff:[],multiplesAttack:[],
		eff:[{type:5,num:['80%','90%','100%','110%','120%']}],buff:[{type:51,num:['5%','6%','7%','8%','9%']}],buffCount:[1,2,3,4,5],buffChance:['50%','55%','60%','65%','70%'],atkCount:[1],sp:16},
	{idx:259,
		...
		attackEff:[],multiplesAttack:[],
		eff:[{type:5,num:['70%','80%','90%','100%','110%']}],buff:[{type:56,num:[]}],buffCount:[],buffChance:['2%','4%','6%','8%','10%'],atkCount:[1],sp:15},
	{idx:260,
		na:{ko:'무리사냥1',en:'Herd Hunt1',jp:'群れ狩り1'},element_type:12,cate:3,
		txt:'<area>, <dmg>, <el>',
		ta_:1,ta:[22,22,21,21,20],effAnimation:'earth4',effAnimationRepeat:1,effSize:[5,5,5,5,5],effRotate:0,effFilter:'',
		attackEff:[],multiplesAttack:[],
		eff:[{type:5,num:['90%','120%','90%','120%','130%']}],atkCount:[1],sp:20},
	{idx:261,
		na:{ko:'무리사냥2',en:'Herd Hunt2',jp:'群れ狩り2'},element_type:11,cate:3,
		txt:'<area>, <dmg>, <el>',
	...
	{idx:262,
		...
		attackEff:[],multiplesAttack:[],
		eff:[{type:5,num:['100%','120%','140%','160%','170%']}],atkCount:[1],sp:18},
	{idx:263,
		na:{ko:'물어뜯기',en:'Bite off',jp:'噛むこと'},element_type:3,cate:3,
		txt:'<area>, <dmg>, <el>',
		ta_:1,ta:[1,1,1,1,1],effAnimation:'bite1',effAnimationRepeat:1,effSize:[1.5,1.75,2,2.25,2.5],effRotate:0,effFilter:'',
		attackEff:[],multiplesAttack:[],
		eff:[{type:3,num:['160%','170%','180%','190%','200%']}],atkCount:[1],sp:12},
	{idx:264,
	...
	{idx:266,
		...
		txt:'<area>, <turn> <buff>',
		ta_:0,ta:[23,23,23,23,23],effAnimation:'buff6',effAnimationRepeat:1,effSize:[1.5,1.75,2,2.25,2.5],effRotate:0,effFilter:'',
		attackEff:[],multiplesAttack:[],
		buff:[{type:17,num:['10%','15%','20%','25%','30%']},{type:22,num:['10%','15%','20%','25%','30%']}],buffCount:[2,2,3,3,4],atkCount:[0],sp:30},
	{idx:267,
	...
	{idx:268,
		...
		attackEff:[],multiplesAttack:[],
	eff:[{type:4,num:['120%','140%','160%','180%','180%']}],buffCount:[2,2,3,3,4],atkCount:[0],sp:23},
	{idx:269,
		...
		attackEff:[],multiplesAttack:[],
		buff:[{type:4,num:['-10%','-15%','-20%','-25%','-30%']},{type:6,num:['-10%','-15%','-20%','-25%','-30%']}],buffCount:[2,2,3,3,4],atkCount:[0],sp:17},
	{idx:270,
		na:{ko:'추격하기1',en:'Catch up1',jp:'追いかける1'},element_type:3,cate:8,
		txt:'<area>, <dmg>, <el>, <turn> <buff>',
		ta_:0,ta:[23,23,23,23,23],effAnimation:'blood16',effAnimationRepeat:1,effSize:[1.5,1.75,2,2.25,2.5],effRotate:0,effFilter:'',
		attackEff:[],multiplesAttack:[],
		eff:[{type:3,num:['50%','60%','70%','80%','90%']}],buff:[{type:10,num:['50%','60%','70%','80%','90%']}],buffCount:[0,0,0,0,0],atkCount:[0],sp:10},
	{idx:271,
		na:{ko:'추격하기2',en:'Catch up2',jp:'追いかける2'},element_type:1,cate:8,
		txt:'<area>, <dmg>, <el>, <turn> <buff>',
		ta_:0,ta:[23,23,23,23,23],effAnimation:'blood16',effAnimationRepeat:1,effSize:[1.5,1.75,2,2.25,2.5],effRotate:0,effFilter:'invert(100%)',
		attackEff:[],multiplesAttack:[],
		eff:[{type:3,num:['80%','90%','100%','120%','130%']}],buff:[{type:10,num:['30%','40%','50%','60%','70%']}],buffCount:[0,0,0,0,0],atkCount:[0],sp:10},
	{idx:272,
		...
		attackEff:[],multiplesAttack:[],
		buff:[{type:13,num:['10%','15%','20%','25%','30%']},{type:14,num:['10%','15%','20%','25%','30%']}],buffCount:[2,2,2,3,3],atkCount:[0],sp:20},
	{idx:273,
		na:{ko:'무거운 한방',en:'Heavy blow',jp:'重い一撃'},element_type:5,cate:3,
		txt:'<area>, <multiples>, <atkEff><dmg>, <el>',
		ta_:1,ta:[27,27,37,37,20],effAnimation:'custom01',effAnimationRepeat:1,effSize:[5,5,5,5,5],effRotate:0,effFilter:'',
		attackEff:[{type:1,num:['-5%','-5%','-10%','-10%','-20%']}],multiplesAttack:[{type:50,num:['25%','30%','35%','40%','50%']}],
		eff:[{type:3,num:['140%','150%','160%','180%','200%']}],atkCount:[1],sp:25},
	{idx:274,
		na:{ko:'가벼운 두방',en:'Light double blow',jp:'軽い二撃'},element_type:5,cate:3,
		txt:'<area>, <multiples>, <atkEff><dmg>, <el>',
		ta_:1,ta:[27,27,37,37,20],effAnimation:'custom01',effAnimationRepeat:1,effSize:[1,1,1.5,1.5,2],effRotate:0,effFilter:'invert(100%)',
		attackEff:[{type:1,num:['-10%','-10%','-15%','-15%','-15%']}],multiplesAttack:[{type:44,num:['10%','15%','20%','25%','30%']}],
		eff:[{type:3,num:['100%','100%','120%','120%','150%']}],atkCount:[2],sp:17},
	{idx:275,
	...
	{idx:276,
		...
		attackEff:[],multiplesAttack:[],
		eff:[{type:5,num:['100%','110%','120%','130%','140%']}],atkCount:[1],sp:22},
	{idx:277,
		na:{ko:'모래뿌리기',en:'Sanding',jp:'砂まき'},element_type:12,cate:7,
		txt:'<area>, <atkEff><dmg>, <el>',
		ta_:1,ta:[28,28,28,29,29],effAnimation:'earth0',effAnimationRepeat:1,effSize:[1,1.25,1.5,6,7],effRotate:0,effFilter:'',
		attackEff:[],multiplesAttack:[],
		eff:[{type:5,num:['110%','120%','130%','140%','150%']}],buff:[{type:53,num:[]}],buffCount:[1,1,2,2,3],buffChance:['20%','25%','30%','35%','40%'],atkCount:[1],sp:18},
	{idx:278,
	...
	{idx:279,
		...
		eff:[{type:5,num:['90%','100%','110%','120%','130%']}],buff:[{type:54,num:[]}],buffCount:[2,2,2,2,2],buffChance:['20%','25%','30%','35%','40%'],atkCount:[1],sp:25},
	{idx:280,
		...
		attackEff:[],multiplesAttack:[],
		eff:[{type:5,num:['120%','130%','140%','150%','160%']}],buff:[{type:57,num:[]}],buffCount:[2,2,2,2,2],buffChance:['20%','25%','30%','35%','40%'],atkCount:[1],sp:23},
	{idx:281,
	...
	{idx:288,
		...
		attackEff:[],multiplesAttack:[],
		eff:[{type:45,num:['140%','150%','160%','170%','180%']}],atkCount:[1],sp:30},
	{idx:289,
		...
		attackEff:[],multiplesAttack:[],
		eff:[{type:41,num:['140%','150%','160%','170%','180%']}],atkCount:[1],sp:15},
	{idx:290,
		na:{ko:'몸통박치기1',en:'Body Slam1',jp:'胴体叩き1'},element_type:4,cate:7,
		txt:'<area>, <dmg>, <el>, <chance> <turn> <buff>',
		ta_:1,ta:[1,4,4,4,5],effAnimation:'dark23',effAnimationRepeat:1,effSize:[1.5,1.5,2,2,2.5],effRotate:0,effFilter:'',
		attackEff:[],multiplesAttack:[],
		eff:[{type:3,num:['140%','150%','160%','170%','180%']}],buff:[{type:54,num:[]}],buffCount:[1,1,2,2,2],buffChance:['20%','22.5%','25%','27.5%','30%'],atkCount:[1],sp:12},
	{idx:291,
		na:{ko:'몸통박치기2',en:'Body Slam2',jp:'胴体叩き2'},element_type:4,cate:7,
		txt:'<area>, <dmg>, <el>, <chance> <turn> <buff>',
		ta_:1,ta:[1,8,8,8,9],effAnimation:'dark23',effAnimationRepeat:1,effSize:[1.5,1.5,2,2,2.5],effRotate:0,effFilter:'hue(90deg)',
		attackEff:[],multiplesAttack:[],
		eff:[{type:3,num:['160%','170%','180%','190%','200%']}],buff:[{type:54,num:[]}],buffCount:[2,2,2,2,2],buffChance:['15%','17.5%','20%','22.5%','25%'],atkCount:[1],sp:15},
	{idx:292,
		na:{ko:'몸통박치기3',en:'Body Slam3',jp:'胴体叩き3'},element_type:4,cate:7,
		txt:'<area>, <dmg>, <el>, <chance> <turn> <buff>',
		ta_:1,ta:[1,5,5,5,9],effAnimation:'dark23',effAnimationRepeat:1,effSize:[1.5,1.5,2,2,2.5],effRotate:0,effFilter:'hue(180deg)',
		attackEff:[],multiplesAttack:[],
		eff:[{type:3,num:['170%','180%','190%','200%','210%']}],buff:[{type:54,num:[]}],buffCount:[2,2,2,3,3],buffChance:['10%','12.5%','15%','17.5%','20%'],atkCount:[1],sp:18},
	{idx:293,
		na:{ko:'훔쳐 먹기',en:'Steal and eat',jp:'盗み食い'},element_type:12,cate:13,
		txt:'<area>, <dmg>, <el>',
	...
	{idx:295,
		...
		eff:[{type:5,num:['120%','130%','140%','150%','160%']}],atkCount:[1],sp:15},
	{idx:296,
		na:{ko:'급소타격',en:'Rapid Fire',jp:'急所打撃'},element_type:3,cate:7,
		txt:'<area>, <dmg>, <el>, <chance> <turn> <buff>',
	...
	{idx:297,
		...
		attackEff:[],multiplesAttack:[],
		buff:[{type:48,num:[]}],buffCount:[1,1,2,2,2],atkCount:[1],sp:20},
	{idx:298,
		na:{ko:'흉내내기',en:'Mimicry',jp:'模倣する'},element_type:11,cate:5,
		txt:'<area>, <turn> <buff>',
		skillClass:1,
		ta_:0,ta:[23,23,23,23,23],effAnimation:'buff38',effAnimationRepeat:1,effSize:[1.5,1.75,2,2.25,2.5],effRotate:0,effFilter:'',
		attackEff:[],multiplesAttack:[],
		buff:[{type:55,num:[]}],buffCount:[3,3,3,3,3],atkCount:[1],sp:1},
	'','',//300
	{idx:239,
		...
		buff:[{type:2,num:['70%','75%','80%','85%','90%']}],buffCount:[4,4,4,4,4],buffChance:['70%','75%','80%','85%','90%'],atkCount:[1],sp:5},
	{idx:240,
...
// 할퀴기, 물기, 치기
// 손톱&뿔 갈기(공 buff)●, 하악질(공 debuff)●, 꾹꾹이(술공 debuff)●, 그루밍(속도 buff)●, 빵굽기2(buff)●,
// 한손타격1(치기)●, 양손타격1(치기)●, 뒷발차기1(치기)●, 바람발톱(바람)●

// * 1사자 - 사자의 빛나는 영광(passive)●, 초원의지배자(빛 condition)●, 야행성(속도 condition)●,
// 할퀴기, 물기,
// 손톱&뿔 갈기(공 buff)●, 포효(속도 debuff)●, 하악질(공 debuff)●, 빵굽기1(술공 buff)●, 금빛갈기(빛,땅 buff)●, 
// 한손타격2(치기)●, 양손타격1(치기)●, 뒷발차기1(치기)●, 송곳니뚫기(물기)●, 무리사냥1(땅,광)●, 화염발톱(화)●

// * 2호랑이 - 호랑이의 거친 용맹(passive)●, 밀림의지배자(수 condition)●, 야행성(속도 condition)●,
// 할퀴기, 물기,
// 손톱&뿔 갈기(공 buff)●, 포효(속도 debuff)●, 하악질(공 debuff)●, 빵굽기1(술공 buff)●, 피의서약(화,수 buff)●, 
// 한손타격1(치기)●, 양손타격2(치기)●, 뒷발차기1(치기)●, 송곳니뚫기(물기)●, 앞발휘두르기(광)●, 얼음발톨(수)●, 후려치기(치기)●, 야습(암,광 condition)●

// * 3강아지 - 강아지의 충성스러운 용기(passive), 개과(passive)
// 물기, 치기
// 영역표시(buff)●, 냄새맡기(buff)●, 
// 뒷발차기2(치기)●, 송곳니뚫기(물기)●, 물어뜯기(물기)●, 무리사냥2(바람,광)●, 광견병(독,광역)●, 추격하기1(반격기)●, 

// * 4늑대 - 늑대의 강인한 의리(passive), 야행성(속도 condition)●, 개과(passive)
// 물기, 치기
// 영역표시(buff)●, 하울링(buff)●, 냄새맡기(buff)●,
// 뒷발차기2(치기)●, 송곳니뚫기(물기)●, 물어뜯기(물기)●, 무리사냥1(땅,광)●, 무리사냥2(바람,광)●, 광견병(독,광역)●,
// [유혹(여우한정)], 
...
// 물기, 치기, 던지기 
// 조롱하기(buff), 구토(독, 광역)●, 눈알찌르기(쪼기),
// 돌던지기(땅)●, 모래뿌리기(땅)●, 눈덩이던지기(수)●, 침뱉기(수, 광)●, 훔쳐먹기(회복,자신)●, 고릴라흉내내기(),
// [온천반신욕(일본원숭이한정)],

// * 10고릴라 - 고릴리의 막강한 파괴(atk)(passive), 
// 치기, 누르기, 던지기
// 몸집 키우기(buff)●, 포효(속도 debuff)●, 가슴치기(buff), 돌진2(광역, 치기)●
// 허리접기(5), 모래뿌리기(땅)●, 1톤 펀치(치기), 돌던지기(땅)●, 바위던지기(땅)●, 눈덩이던지기(수)●, 헤드락(누르기), 몸통박치기1(치기)●, 고드름던지기(수)
...
// 쪼기, 누르기
// 몸집 키우기(buff)●, 손톱&뿔 갈기(buff)●,
// 뿔찌르기(쪼기), 돌진3(광역, 치기)●, 머리박치기(치기), 발구르기(광역, 땅), 짓밟기2(누르기), 추격하기2(반격기)●, 몸통박치기2(치기)●, 

// * 13곰 - 곰의 우렁찬 포효(hp)(passive), 
// 할퀴기, 치기
// 몸집 키우기(buff)●, 포효(속도 debuff), 
// 한손타격2(치기)●, 양손타격2(치기)●, 후려치기(치기)●, 휘둘러치기(광역, 치기), 나무타기(회피), 꿀빨기(회복), 발톱파고들기(할퀴기), 몸통박치기1(치기)●, 

// * 14말 - 말의 날쌘 이동력(spd)(passive), 반격(passive),
// 치기
// 질주(buff), 
// 뒷발차기3(치기)●, 돌진2(광역, 치기)●, 짓밟기1(누르기), 

// * 15사슴 - 사슴의 성스러운 보호(mdk)(passive),
// 쪼기, 치기
// 손톱&뿔 갈기(buff)●,
// 침뱉기(수, 광)●, 뿔찌르기(쪼기), 정화(상태이상치료), 그룹정화(상태이상치료), 뒷발차기1(치기)●, 돌진1(광역, 치기)●
	
// * 16코뿔소 - 코뿔소의 돌진하는 용맹(passive), 
// 쪼기, 누르기,
// 몸집 키우기(buff)●,
// 코뿔박치기(쪼기), 뚫기(), 돌진3(광역, 치기)●, 머리박치기(치기), 발구르기(광역, 땅), 몸통박치기2(치기)●,

// * 17코끼리 - 코끼리의 무거운 한방(광역공격위주)(passive), 
// 누르기, 던지기
// 몸집 키우기(buff)●, 포효(속도 debuff), 
// 돌진3(광역,치기)●, 무거운한방(광역,누르기)●, 가변운두방(광역,누르기)●, 발구르기(광역, 땅), 돌던지기(땅)●, 바위던지기(광역,땅)●, 물대포(광역,수)●, 깔아뭉개기(광역,누르기), 땅울림(땅,광), 꼬리치기(치기), 짓밟기2(누르기), 몸통박치기3(치기)●,

// * 18기린 - 기린의 충실한 정찰력(passive), 밤샘경계(passive),
// 누르기, 치기
// 기침(buff),
// 침뱉기(수, 광)●, 목치기(치기), 뒷발차기2(치기)●, 돌진2(광역, 치기)●, 머리박치기(치기), 초저주파(광역, 빛), 발구르기(광역, 땅)
...
// 물기, 할퀴기
// 몸집 키우기(buff)●, 야행성(속도 condition)●,
// 혓바닥공격(치기), 허물벗기(회복), 꼬리자르기(회피), 삼키기(독, 단일)●, 응원의 박수(빛,힐)●, 훔쳐먹기(회복,자신)●,
// 위장술(카멜레온한정), 

// * 23거북이 - 거북이의 강철 피부(passive), 파충류과(passive)
// 물기,
// 절단물기(물기), 튼튼한등껍질(방어), 방향틀기(대기상태, 회피증가)

// * 24개구리 - 개구리의 신속한 점프력(passive), 개구리 뿔피리(passive), 파충류과(passive)
// 치기
// 뒷발차기1(치기)●, 훔쳐먹기(회복,자신)●, 개구리 기우제(날씨변경), 음파공격(광역, 빛), 혓바닥공격(치기), 고드름던지기(수), 점프(회피), 물기(물기)
...
//물리: 두번 공격, 연속 공격, 무차별 공격, 세게 공격, xx펀치(속성), 기습 공격, 죽기살기, 방어, 철벽방어, 이동, 다구리,
//불: 불바다, 불침, 불대포
//물: 바다폭풍, 폭풍우, 물대포, 물안개
