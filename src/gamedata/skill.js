...
export const skill = [
	...
	{idx:15,
		...
		txt:'<job>',
		skillClass:2,
		ta_:0,ta:[],effAnimation:'',effAnimationRepeat:1,effSize:1,effRotate:0,effFilter:'',allEff:[],job:1,
		eff:[{type:'grade',num:['10','20','30','40','50']}],sp:5},
	{idx:16,
		na:{ko:'선박 전문',en:'Ship Specialty',jp:'船舶専門'},element_type:0,cate:[11],
		txt:'<job>',
		skillClass:2,
		ta_:0,ta:[],effAnimation:'',effAnimationRepeat:1,effSize:1,effRotate:0,effFilter:'',allEff:[],job:2,
		eff:[{type:'grade',num:['5','10','15','20','25']}],sp:5},
	{idx:17,
		na:{ko:'장비 전문',en:'Equipment Specialty',jp:'設備専門'},element_type:0,cate:[11],
		txt:'<job>',
		skillClass:2,
		ta_:0,ta:[],effAnimation:'',effAnimationRepeat:1,effSize:1,effRotate:0,effFilter:'',allEff:[],job:3,
		eff:[{type:'grade',num:['5','10','15','20','25']}],sp:5},
	{idx:18,
		na:{ko:'조각',en:'Sculpture',jp:'彫刻'},element_type:0,cate:[11],
		txt:'<job>',
		skillClass:2,
		ta_:0,ta:[],effAnimation:'',effAnimationRepeat:1,effSize:1,effRotate:0,effFilter:'',allEff:[],job:4,
		eff:[{type:'grade',num:['5','10','15','20','25']}],sp:5},
	{idx:19,
		na:{ko:'식물 재배',en:'Plant Cultivation',jp:'植物栽培'},element_type:0,cate:[11],
		txt:'<job>',
		skillClass:2,
		ta_:0,ta:1,effAnimation:'',effAnimationRepeat:1,effSize:1,effRotate:0,effFilter:'',allEff:[],job:5,
		eff:[{type:'grade',num:['5','10','15','20','25']}],sp:5},
	{idx:20,
		na:{ko:'연금술',en:'Alchemy',jp:'錬金術'},element_type:0,cate:[11],
		txt:'<job>',
		skillClass:2,
		ta_:0,ta:[],effAnimation:'',effAnimationRepeat:1,effSize:1,effRotate:0,effFilter:'',allEff:[],job:6,
		eff:[{type:'grade',num:['5','10','15','20','25']}],sp:5},
	{idx:21,
		na:{ko:'보석 세공',en:'Jewelry',jp:'宝石細工'},element_type:0,cate:[11],
		txt:'<job>',
		skillClass:2,
		ta_:0,ta:[],effAnimation:'',effAnimationRepeat:1,effSize:1,effRotate:0,effFilter:'',allEff:[],job:7,
		eff:[{type:'grade',num:['5','10','15','20','25']}],sp:5},
	{idx:22,
		na:{ko:'관찰력',en:'Observation',jp:'観察力'},element_type:0,cate:[11],
		txt:'<job>',
		skillClass:2,
		ta_:0,ta:[],effAnimation:'',effAnimationRepeat:1,effSize:1,effRotate:0,effFilter:'',allEff:[],job:8,
		eff:[{type:'grade',num:['5','10','15','20','25']}],sp:5},
	{idx:23,
		na:{ko:'예술',en:'Art',jp:'アート'},element_type:0,cate:[11],
		txt:'<job>',
		skillClass:2,
		ta_:0,ta:[],effAnimation:'',effAnimationRepeat:1,effSize:1,effRotate:0,effFilter:'',allEff:[],job:9,
		eff:[{type:'grade',num:['5','10','15','20','25']}],sp:5},	
	// {idx:4,
	...
	{idx:207,
		...
		txt:'<area>, <buff>',
		skillClass:0,
		ta_:0,ta:[23,23,23,23,23],effAnimation:'',effAnimationRepeat:1,effSize:1,effRotate:0,effFilter:'',allEff:[0,0,0,0,0],
	...
	{idx:208,
		...
		skillClass:2,
		ta_:0,ta:[20,20,20,20,20],effAnimation:'',effAnimationRepeat:1,effSize:1,effRotate:0,effFilter:'',allEff:[0,0,0,0,0],
	...
	{idx:213,
		...
		txt:'<area>, <turn> <buff>',
		skillClass:0,
		ta_:0,ta:[23,23,23,23,23],effAnimation:'buff35',effAnimationRepeat:1,buffAnimation:0,effSize:1,effRotate:0,effFilter:'',allEff:[0,0,0,0,0],
	...
	{idx:214,
		...
		txt:'<area>, <turn> <buff>',
		skillClass:1,
		ta_:0,ta:[20,20,20,20,20],effAnimation:'buff37',effAnimationRepeat:1,buffAnimation:1,effSize:1.5,effRotate:0,effFilter:'',allEff:[0,0,0,0,0],
	...
	{idx:215,
		...
		txt:'<area>, <buff>',
		skillClass:0,
		ta_:0,ta:[23,23,23,23,23],effAnimation:'buff33',effAnimationRepeat:1,effSize:1,effRotate:0,effFilter:'',allEff:[0,0,0,0,0],
		buff:[{type:0,num:['20%','30%','40%','50%','70%']}],atkCount:[1],sp:0},
	{idx:216,
		na:{ko:'빵굽기1',en:'Baking Cat1',jp:'パン焼き機1'},element_type:0,cate:[5],
		txt:'<area>, <turn> <buff>',
		skillClass:0,
		ta_:0,ta:[23,23,23,23,23],effAnimation:'buff30',effAnimationRepeat:1,effSize:1,effRotate:0,effFilter:'',allEff:[0,0,0,0,0],
	...
	{idx:217,
		...
		txt:'<area>, <turn> <buff>',
		skillClass:0,
		ta_:0,ta:[23,23,23,23,23],effAnimation:'buff28',effAnimationRepeat:1,effSize:1.5,effRotate:0,effFilter:'',allEff:[0,0,0,0,0],
	...
	{idx:225,
		...
		skillClass:0,
		ta_:0,ta:[23,23,23,23,23],effAnimation:'',effAnimationRepeat:1,effSize:1,effRotate:0,effFilter:'',allEff:[],condition:1,
		buff:[{type:8,num:['10','15','25','30','40']}],atkCount:[1],sp:0},
	{idx:226,
		na:{ko:'빵굽기2',en:'Baking Cat2',jp:'パン焼き機2'},element_type:0,cate:[5],
		txt:'<area>, <turn> <buff>',
		skillClass:0,
		ta_:0,ta:[23,23,23,23,23],effAnimation:'buff30',effAnimationRepeat:1,effSize:1,effRotate:0,effFilter:'hue-rotate(90deg)',allEff:[0,0,0,0,0],
