export const skill = [
	...
	{idx:241,
		...
		txt:'<area>, <turn> <buff>',
		ta_:1,ta:[1,22,22,21,21],effAnimation:'buff5',effAnimationRepeat:1,effSize:[1.5,1.75,2,2.25,2.5],effRotate:0,effFilter:'',
		attackEff:[],multiplesAttack:[],
	...
	{idx:277,
		na:{ko:'돌 던지기',en:'Throwing stones',jp:'石投げ'},element_type:12,cate:3,
		...
		eff:[{type:5,num:['120%','130%','140%','150%','160%']}],atkCount:[1],sp:15},
	{idx:278,
		na:{ko:'바위 던지기',en:'Throwing rocks',jp:'石投げゲーム'},element_type:12,cate:7,
		txt:'<area>, <dmg>, <el>, <chance> <turn> <buff>',
	...
	{idx:279,
		na:{ko:'눈덩이 던지기',en:'Throwing snowballs',jp:'雪だるま投げ'},element_type:9,cate:7,
		txt:'<area>, <dmg>, <el>, <chance> <turn> <buff>',
...
// [eff], [buff] 체력HP(0), 행동SP(1), 행동회복RSP(2), 공ATK(3), 방DEF(4), 술공MAK(5), 술방MDF(6), 회복RCV(7), 속도SPD(8), 행운LUK(9), 카운터Atk(10), 쪼기(11), 할퀴기(12), 물기(13), 치기(14), 누르기(15), 던지기(16), 빛(17), 어둠(18), 물(19), 불(20), 바람(21), 땅(22), 치명타(31), 회피(32), 적중률(33), hp회복(41), sp회복(42), hp,sp회복(43), 부활(44), 부활hp회복(45), 출혈(50), 중독(51), 석화(52), 혼란(53), 기절(54), 변이(55), 즉사(56), 57(냉동), 패시브(100)
...
// 돌던지기(땅)●, 모래뿌리기(땅), 눈덩이던지기(수)●, 침뱉기(수, 광)●, 훔쳐먹기(회복,자신)●,
// [온천반신욕(일본원숭이한정)],
