...
export const skill = [
	...
	{idx:3,
		...
		,eff:[{ta_:0,ta:20,type:100,num:['10%','15%','20%','25%','30%']}],atkCount:0,turn:0,sp:0},
	{idx:4,
		na:'불정령',element_type:4,cate:[1],txt:'<u>전체</u> 물리 공격력(ATK)이 <b buff>$(0)</b> <i icon up>증가</i> 한다.'
		,eff:[{ta_:0,ta:3,type:100,num:['10%','15%','20%','25%','30%']}],atkCount:0,turn:0,sp:0},
	{idx:5,
		na:'빛정령',element_type:2,cate:[1],txt:'<u>전체</u> 술법 공격력(MATK)이 <b buff>$(0)</b> <i icon up>증가</i> 한다.'
		,eff:[{ta_:0,ta:5,type:5,num:['10%','15%','20%','25%','30%']}],atkCount:0,turn:0,sp:0},
	{idx:6,
