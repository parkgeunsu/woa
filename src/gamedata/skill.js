...
export const skill = [
	...
	{idx:4,
		na:'학익진 강화',element_type:0,cate:[2],txt:'전투 참여시 <u>전체</u>, 학익진효과가 <b buff>$(0)</b> <i icon up>증가</i> 한다.'
		,ta_:0,ta:10,effAnimation:0
		,eff:[{type:100,num:['20%','25%','30%','35%','40%']}],atkCount:[0],turn:0,sp:0}, //이순신
	{idx:5,
		na:'격려',element_type:0,cate:[2],txt:'전투 참여시 <u>전체</u>, 진형효과가 <b buff>$(0)</b> <i icon up>증가</i> 한다.'
		,ta_:0,ta:10,effAnimation:1
		,eff:[{type:100,num:['10%','15%','20%','25%','30%']}],atkCount:[0],turn:0,sp:0},
	{idx:6,
		na:'불정령',element_type:10,cate:[2],txt:'전투 참여시 <u>전체</u>, 물리 공격력(ATK)이 <b buff>$(0)</b> <i icon up>증가</i> 한다.'
		,ta_:0,ta:10,effAnimation:11
		,eff:[{type:3,num:['10%','15%','20%','25%','30%']}],atkCount:[0],turn:0,sp:0},
	{idx:7,
		na:'빛정령',element_type:7,cate:[2],txt:'전투 참여시 <u>전체</u>, 술법 공격력(MAK)이 <b buff>$(0)</b> <i icon up>증가</i> 한다.'
		,ta_:0,ta:10,effAnimation:3
		,eff:[{type:5,num:['10%','15%','20%','25%','30%']}],atkCount:[0],turn:0,sp:0},
	{idx:8,
		na:'물정령',element_type:9,cate:[2],txt:'전투 참여시 <u>전체</u>, 체력(HP)이 <b buff>$(0)</b> <i icon up>증가</i> 한다.'
		,ta_:0,ta:10,effAnimation:12
	...
	{idx:13,
		na:'철벽방어',element_type:0,cate:[4],txt:'<u>자신</u>, 방어(DEF) <b buff>$(0)</b>와 술법방어(MDF) <b buff>$(1)</b>가 <i icon up>증가</i>한다.'
		,ta_:0,ta:1,effAnimation:0
...
export const animalSkill = [
	{idx:0,
		na:'재빠른 움직임',element_type:0,cate:[2],txt:`전투 참여시 <u>자신</u>, 속도(SPD)가 <b buff>$(0)</b> <i icon up>증가</i> 한다.`
		,ta_:1,ta:1,effAnimation:0,skillClass:0
		,eff:[{type:8,num:['5','10','15','20','25']}],atkCount:[1],turn:1,sp:0},
	{idx:1,
		na:'다같이 산책가자',element_type:2,cate:[2],txt:`전투 참여시 <u>전체</u>, 속도(SPD)가 <b buff>$(0)</b> <i icon up>증가</i> 한다.`
		,ta_:1,ta:10,effAnimation:0,skillClass:1
		,eff:[{type:8,num:['3','6','9','12','15']}],atkCount:[1],turn:1,sp:0},
	{idx:2,
		na:'몸집 키우기',element_type:2,cate:[2],txt:`전투 참여시 <u>자신</u>, 체력(HP)이 <b buff>$(0)</b> <i icon up>증가</i> 한다.`
		,ta_:1,ta:1,effAnimation:1,skillClass:0
		,eff:[{type:0,num:['50%','75%','100%','125%','150%']}],atkCount:[1],turn:1,sp:0},
	{idx:2,
		na:'빵굽기',element_type:2,cate:[5],txt:`<u>자신</u>, 공격력(ATK) <b buff>$(0)</b>과 방어력(DEF) <b buff>$(1)</b>이 <i icon up>증가</i> 한다.`
		,ta_:1,ta:1,effAnimation:2,skillClass:0
		,eff:[{type:3,num:['150%','160%','170%','180%','200%']},{type:4,num:['150%','160%','170%','180%','200%']}],atkCount:[0],turn:1,sp:6},
	{idx:3,
