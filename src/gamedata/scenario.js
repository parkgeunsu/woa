				...
				stage:[
					{
						...
						entry:[
							...
							{idx:'', lv:1, },{idx:'', lv:1, },{pos:1,idx:28, lv:50, grade:4, items: [
								{idx:0, part:1, slot:0, hole:[], lv:2, grade:1,color:["#fff","#0f0"],baseEff:[{type:4,num:['12']}],addEff:[]},
								{idx:1, part:1, slot:0, hole:[], lv:2, grade:1,color:["#fff","#0f0"],baseEff:[{type:4,num:['12']}],addEff:[]},
								{idx:2, part:1, slot:0, hole:[], lv:2, grade:1,color:["#fff","#0f0"],baseEff:[{type:4,num:['12']}],addEff:[]},
								{idx:4, part:1, slot:0, hole:[], lv:2, grade:1,color:["#fff","#0f0"],baseEff:[{type:4,num:['12']}],addEff:[]},
								{},
								{},
								{},
								{},
