export const save = {
    ...
    "ch":[
      {"idx":0,"stateType":0,"element":[11],"grade":6,"stateLuk":146,"lv":45,"exp":10,"hasExp":50000,"actionPoint":20,"battleBeige":[0,0,0,0],"animalBeige":0,"sk":[{"idx":1,"lv":2,"exp":40},{"idx":2,"lv":3,"exp":90},{"idx":16,"lv":1,"exp":0},{"idx":11,"lv":1,"exp":0}],"items":[
        {"idx":0,"slot":0,"hole":[4,0,12,23],"upgrade":1,color:["#fff","#0f0"]},
        {},
    ...
    "items":{
      "equip":[
        {"idx":0,"slot":0,"hole":[4,0,12,23],"upgrade":1,color:["#f00","#0f0"]},
        {"idx":0,"slot":0,"hole":[],"upgrade":1,color:["#fff","#f60"]},
        {"idx":0,"slot":0,"hole":[],"upgrade":1,color:["#000","#fff"]},
        {"idx":0,"slot":0,"hole":[12,0,13],"upgrade":1,color:["#06f","#066"]},
        {"idx":1,"slot":0,"hole":[12,0,13],"upgrade":1,color:["#fff","#f00","#0f4036"]},
        {"idx":2,"slot":0,"hole":[12,0,13],"upgrade":1,color:["#06f"]},
        {"idx":3,"slot":0,"hole":[12,0,13],"upgrade":1,color:["#06f"]},
        {"idx":4,"slot":0,"hole":[12,0,13],"grade":2,"upgrade":2,color:["#06f"]},
        {"idx":5,"slot":0,"hole":[12,0,13],"upgrade":1,color:["#06f"]},
        {"idx":6,"slot":0,"hole":[12,0,13],"upgrade":3,color:["#06f"]},
        {"idx":7,"slot":0,"hole":[12,0,13],"upgrade":1,color:["#06f"]},
        {"idx":9,"slot":0,"hole":[12,0,13],"upgrade":4,color:["#06f"]},
        {"idx":10,"slot":0,"hole":[12,0,13],"upgrade":1,color:["#06f"]},
        {"idx":11,"slot":0,"hole":[12,0,13],"upgrade":1,color:["#06f"]},
        {"idx":12,"slot":0,"hole":[12,0,13],"upgrade":1,color:["#06f"]},
