export const items = {
  ...
  //enhance 강화
    ...
    3:[//무기
      ...
      [//활6
        [//normal,magic,rare,epic
          {idx:0,part:3,grade:1,display:126,na:{ko:'수리검',en:'Shuriken',jp:'手裏剣'},kg:0.5,price:300,color:["#BCBEC0","#000000"],socket:2,txt:{ko:'던져서 적을 맞히는 것을 목적으로 하는 표창 계열의 무기.',en:'A mace-like weapon intended to be thrown and hit enemies.',jp:'投擲して敵を攻撃することを目的とした表彰系の武器。'},eff:[{type:3,num:['10','130']}],actionType:[5],requiredSlot:1,limit:[false,false,false,false,false,true,false,true,true,false,true,false,false,false,false,false,false],country:'',set:0},

          {idx:1,part:3,grade:1,display:127,na:{ko:'궁',en:'Short Bow',jp:'弓'},kg:1.2,price:900,color:["#70C169","#FBA919"],socket:5,txt:{ko:'화살을 먼거리로 보내기위한 도구, 원거리 무기',en:'Tools for sending arrows a long way, ranged weapons',jp:'矢を遠くに飛ばすための道具、遠距離武器。'},eff:[{type:3,num:['100','350']}],actionType:[5],requiredSlot:2,limit:[true,false,false,false,false,false,false,true,true,true,true,false,false,true,false,false,true],country:'',set:0},

          {idx:2,part:3,grade:1,display:128,na:{ko:'장궁',en:'Long Bow',jp:'長弓'},kg:2,price:1200,color:["#ED1F24","#FBA919"],socket:6,txt:{ko:'궁보다 크기가 큰 원거리 무기',en:'Ranged weapons larger than a bow',jp:'弓よりサイズが大きい遠距離武器'},eff:[{type:3,num:['200','490']}],actionType:[5],requiredSlot:2,limit:[true,false,false,false,false,false,false,true,true,true,true,false,false,true,false,false,true],country:'',set:0},

          {idx:3,part:3,grade:1,display:129,na:{ko:'석궁',en:'Crossbow',jp:'クロスボウ'},kg:2.2,price:1200,color:["#A76928","#991B1E","#FBA919"],socket:6,txt:{ko:'활과 유사한 대표적인 발사 무기. 옛 한국에서는 쇠뇌라고 불렀다.',en:'A typical projectile weapon similar to a bow. In ancient Korea, it was called a crossbow.',jp:'弓に似た代表的な発射武器。昔の韓国では弩と呼ばれていた。'},eff:[{type:3,num:['100','550']}],actionType:[5],requiredSlot:2,limit:[true,false,false,false,false,false,false,true,true,true,true,false,false,true,false,false,true],country:'',set:0},
        ],
        [//unique
        ],
        [//legend
      ...
      [//타격7
        [//normal,magic,rare,epic
          {idx:0,part:3,grade:1,display:122,na:{ko:'톤파',en:'Tonfa',jp:'トンファー'},kg:1,price:500,color:["#F7941E"],socket:3,txt:{ko:'중국 拐(괴) 단봉형 무기가 오키나와에 와서 변형되어 오키나와에서 유래한 날없는 타격 무기다.',en:'It is a bladed striking weapon that originated in Okinawa when the Chinese 拐 short-barreled weapon came to Okinawa and was modified.',jp:'中国の拐棒型武器が沖縄に来て変形し、沖縄に由来する刃のない打撃武器である。'},eff:[{type:3,num:['100','200']},{type:5,num:['100','200']}],actionType:[3],requiredSlot:1,limit:[true,false,false,false,true,true,true,true,true,true,true,true,true,true,true,false,true],country:'',set:0},

          {idx:1,part:3,grade:1,display:125,na:{ko:'차크람',en:'Chakram',jp:'チャクラム'},kg:1.2,price:700,color:["#ffffff"],socket:4,txt:{ko:'시크교 신도의 전통 투척 무기, 산스크리트어로 \'둥근\', \'원\', \'바퀴\' 등을 뜻하는 차크라에서 유래하였다.',en:'A traditional throwing weapon of the Sikhs, it comes from the Sanskrit word chakra, which means "round," "circle," "wheel," etc.',jp:'シーク教徒の伝統的な投擲武器、サンスクリット語で「丸い」、「円」、「輪」などを意味するチャクラに由来する。'},eff:[{type:3,num:['50','250']},{type:5,num:['50','250']}],actionType:[1],requiredSlot:1,limit:[true,false,false,false,true,true,true,true,true,true,true,true,true,true,true,false,true],country:'',set:0},

          {idx:2,part:3,grade:1,display:159,na:{ko:'너클',en:'Knuckle',jp:'ナックル'},kg:0.5,price:500,color:["#939598","#000000"],socket:4,txt:{ko:'뾰족한 돌기가 있는 금속의 맨손무기.',en:'A metal, bare weapon with a sharp point.',jp:'尖った突起のある金属の素手武器。'},eff:[{type:3,num:['50','150']},{type:5,num:['50','150']}],actionType:[3],requiredSlot:1,limit:[true,false,false,false,true,true,true,true,true,true,true,true,true,true,true,false,true],country:'',set:0},
          
          {idx:3,part:3,grade:1,display:130,na:{ko:'철선',en:'Iron Fan',jp:'鐵扇'},kg:0.3,price:500,color:["#ffffff"],socket:4,txt:{ko:'쇠로 만든 부채.',en:'A fan made of iron.',jp:'鉄製の扇子。'},eff:[{type:3,num:['1','111']}],actionType:[5],requiredSlot:1,limit:[true,false,false,false,false,false,true,true,true,true,true,true,true,true,false,false,false],country:'',set:0},
        ],
        [//unique
        ],
        [//legend
