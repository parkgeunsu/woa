        ...
        3:[//무기
            [//단검0
                [//normal,magic,rare,epic
                    ...
                    {idx:2,part:3,grade:1,display:102,na:{ko:'장도',en:'Self Defense Knife'},kg:0.2,price:100,color:["#ffffff","#000000","#FFFFFF"],socket:2,txt:{ko:'칼집이 있는 작은 칼을 말하며, 허리춤에 차고 옷고름에 찬다 하여 패도(佩刀), 주머니에 넣고 다닌다 하여 낭도(囊刀)라고도 불렀다.',en:''},eff:[{type:4,num:['5','50']}],set:0},
