export const items = {
        ...
        1:[//모자
            [
                [//normal,magic,rare,epic
                    ...
                    {idx:2,part:1,grade:1,display:10,na:{ko:'스컬 캡',en:'Skull Cap'},kg:3,price:500,color:["#fff","#000"],socket:2,txt:{ko:'반구 형태의 철제 투구',en:'A hemispherical iron helmet'},eff:[{type:4,num:['50','100']},{type:6,num:['100','200']}],actionType:"",requiredSlot:1,limit:[true,true,true,true,true,true,true,true,true,true,true,true,false,true,true,true,true],set:0},
                    {idx:3,part:1,grade:1,display:2,na:{ko:'코니컬 헬름',en:'Conical Helm'},kg:5,price:500,color:["#fff","#000"],socket:2,txt:{ko:'원뿔형태의 철제 투구',en:'A conical iron helmet'},eff:[{type:4,num:['100','150']},{type:6,num:['50','200']}],actionType:"",requiredSlot:1,limit:[true,true,true,true,false,true,false,false,false,true,true,true,false,true,true,true,true],set:0},
                    {idx:4,part:1,grade:1,display:7,na:{ko:'풀 헬름',en:'Full Helm'},kg:7,price:700,color:["#fff","#000"],socket:3,txt:{ko:'헬름을 강화시킨 투구',en:'A helmet reinforced with Helm'},eff:[{type:4,num:['150','250']},{type:6,num:['100','200']}],actionType:"",requiredSlot:1,limit:[true,true,true,true,false,true,false,false,false,true,true,true,false,true,true,true,true],set:0},
                    {idx:5,part:1,grade:1,display:9,na:{ko:'본 헬름',en:'Bone Helm'},kg:6,price:700,color:["#fff","#58595B"],socket:4,txt:{ko:'짐승의 뼈로 만든 투구',en:'A helmet made of animal bones'},eff:[{type:4,num:['100','300']},{type:6,num:['150','300']}],actionType:"",requiredSlot:1,limit:[true,true,true,true,false,true,false,false,false,true,true,true,false,true,true,true,true],set:0},
                    {idx:6,part:1,grade:1,display:6,na:{ko:'헤럴드리 헬름',en:'Heraldry Helm'},kg:14,price:1500,color:["#fff","#000"],socket:3,txt:{ko:'폐쇄형 강철 투구',en:'A closed steel helmet'},eff:[{type:4,num:['200','350']},{type:6,num:['200','300']}],actionType:"",requiredSlot:1,limit:[true,false,false,true,false,false,false,false,false,false,true,false,false,true,false,false,false],set:0},
                    {idx:7,part:1,grade:1,display:8,na:{ko:'그레이트 헬름',en:'Great Helm'},kg:25,price:2000,color:["#fff","#000","#AF8C4F"],socket:4,txt:{ko:'우수한 방어효과 만큼 무거운 투구',en:'Helm as heavy as a good defense'},eff:[{type:4,num:['350','500']},{type:6,num:['200','350']}],actionType:"",requiredSlot:1,limit:[true,false,false,true,false,false,false,false,false,false,true,false,false,true,false,false,false],set:0},
                ],
                [//unique
    ...
    hole:[//홀 장착 아이템
        ...
        {idx:101,grade:2,display:101,na:{ko:'작은 백 염료',en:''},kg:0.1,price:1000,txt:{ko:'작은 백색 염료 ',en:''},color:'#ffffff',size:0,},
        {idx:102,grade:2,display:102,na:{ko:'작은 흑 염료',en:''},kg:0.1,price:1000,txt:{ko:'작은 흑색 염료 ',en:''},color:'#000000',size:0,},
        {idx:103,grade:2,display:103,na:{ko:'작은 청록 염료',en:''},kg:0.1,price:1000,txt:{ko:'작은 청록색 염료 ',en:''},color:'#008888',size:0,},
        {idx:104,grade:2,display:104,na:{ko:'작은 카키 염료',en:''},kg:0.1,price:1000,txt:{ko:'작은 카키색 염료 ',en:''},color:'#888800',size:0,},
        {idx:105,grade:2,display:105,na:{ko:'작은 하늘 염료',en:''},kg:0.1,price:1000,txt:{ko:'작은 하늘색 염료 ',en:''},color:'#00ffff',size:0,},
        {idx:106,grade:2,display:106,na:{ko:'작은 분홍 염료',en:''},kg:0.1,price:1000,txt:{ko:'작은 분홍색 염료 ',en:''},color:'#ff00ff',size:0,},
        {idx:107,grade:2,display:107,na:{ko:'작은 자주 염료',en:''},kg:0.1,price:1000,txt:{ko:'작은 자주색 염료 ',en:''},color:'#880088',size:0,},
        {idx:108,grade:2,display:108,na:{ko:'작은 녹 염료',en:''},kg:0.1,price:1000,txt:{ko:'작은 녹색색 염료 ',en:''},color:'#008800',size:0,},
        {idx:109,grade:2,display:109,na:{ko:'작은 연두 염료',en:''},kg:0.1,price:1000,txt:{ko:'작은 연두색 염료 ',en:''},color:'#00ff00',size:0,},
        {idx:110,grade:2,display:110,na:{ko:'작은 노랑 염료',en:''},kg:0.1,price:1000,txt:{ko:'작은 노랑색 염료 ',en:''},color:'#ffff00',size:0,},
        {idx:111,grade:2,display:111,na:{ko:'작은 주황 염료',en:''},kg:0.1,price:1000,txt:{ko:'작은 주황색 염료 ',en:''},color:'#ff8800',size:0,},
        {idx:112,grade:2,display:112,na:{ko:'작은 빨강 염료',en:''},kg:0.1,price:1000,txt:{ko:'작은 빨강색 염료 ',en:''},color:'#ff0000',size:0,},
        {idx:113,grade:2,display:113,na:{ko:'작은 보라 염료',en:''},kg:0.1,price:1000,txt:{ko:'작은 보라색 염료 ',en:''},color:'#8800ff',size:0,},
        {idx:114,grade:2,display:114,na:{ko:'작은 파랑 염료',en:''},kg:0.1,price:1000,txt:{ko:'작은 파랑색 염료 ',en:''},color:'#0000ff',size:0,},
        {idx:115,grade:2,display:115,na:{ko:'작은 군청 염료',en:''},kg:0.1,price:1000,txt:{ko:'작은 군청색 염료 ',en:''},color:'#000088',size:0,},
        '','','','','',
        {idx:121,grade:3,display:121,na:{ko:'백 염료',en:''},kg:0.1,price:1000,txt:{ko:'백색 염료 ',en:''},color:'#ffffff',size:1,},
        {idx:122,grade:3,display:122,na:{ko:'흑 염료',en:''},kg:0.1,price:1000,txt:{ko:'흑색 염료 ',en:''},color:'#000000',size:1,},
        {idx:123,grade:3,display:123,na:{ko:'청록 염료',en:''},kg:0.1,price:1000,txt:{ko:'청록색 염료 ',en:''},color:'#008888',size:1,},
        {idx:124,grade:3,display:124,na:{ko:'카키 염료',en:''},kg:0.1,price:1000,txt:{ko:'카키색 염료 ',en:''},color:'#888800',size:1,},
        {idx:125,grade:3,display:125,na:{ko:'하늘 염료',en:''},kg:0.1,price:1000,txt:{ko:'하늘색 염료 ',en:''},color:'#00ffff',size:1,},
        {idx:126,grade:3,display:126,na:{ko:'분홍 염료',en:''},kg:0.1,price:1000,txt:{ko:'분홍색 염료 ',en:''},color:'#ff00ff',size:1,},
        {idx:127,grade:3,display:127,na:{ko:'자주 염료',en:''},kg:0.1,price:1000,txt:{ko:'자주색 염료 ',en:''},color:'#880088',size:1,},
        {idx:128,grade:3,display:128,na:{ko:'녹 염료',en:''},kg:0.1,price:1000,txt:{ko:'녹색 염료 ',en:''},color:'#008800',size:1,},
        {idx:129,grade:3,display:129,na:{ko:'연두 염료',en:''},kg:0.1,price:1000,txt:{ko:'연두색 염료 ',en:''},color:'#00ff00',size:1,},
        {idx:130,grade:3,display:130,na:{ko:'노랑 염료',en:''},kg:0.1,price:1000,txt:{ko:'노랑색 염료 ',en:''},color:'#ffff00',size:1,},
        {idx:131,grade:3,display:131,na:{ko:'주황 염료',en:''},kg:0.1,price:1000,txt:{ko:'주황색 염료 ',en:''},color:'#ff8800',size:1,},
        {idx:132,grade:3,display:132,na:{ko:'빨강 염료',en:''},kg:0.1,price:1000,txt:{ko:'빨강색 염료 ',en:''},color:'#ff0000',size:1,},
        {idx:133,grade:3,display:133,na:{ko:'보라 염료',en:''},kg:0.1,price:1000,txt:{ko:'보라색 염료 ',en:''},color:'#8800ff',size:1,},
        {idx:134,grade:3,display:134,na:{ko:'파랑 염료',en:''},kg:0.1,price:1000,txt:{ko:'파랑색 염료 ',en:''},color:'#0000ff',size:1,},
        {idx:135,grade:3,display:135,na:{ko:'군청 염료',en:''},kg:0.1,price:1000,txt:{ko:'군청색 염료 ',en:''},color:'#000088',size:1,},
        '','','','','',
        {idx:141,grade:4,display:141,na:{ko:'큰 백 염료',en:''},kg:0.2,price:1000,txt:{ko:'큰 백색 염료 ',en:''},color:'#ffffff',size:2,},
        {idx:142,grade:4,display:142,na:{ko:'큰 흑 염료',en:''},kg:0.2,price:1000,txt:{ko:'큰 흑색 염료 ',en:''},color:'#000000',size:2,},
        {idx:143,grade:4,display:143,na:{ko:'큰 청록 염료',en:''},kg:0.2,price:1000,txt:{ko:'큰 청록색 염료 ',en:''},color:'#008888',size:2,},
        {idx:144,grade:4,display:144,na:{ko:'큰 카키 염료',en:''},kg:0.2,price:1000,txt:{ko:'큰 카키색 염료 ',en:''},color:'#888800',size:2,},
        {idx:145,grade:4,display:145,na:{ko:'큰 하늘 염료',en:''},kg:0.2,price:1000,txt:{ko:'큰 하늘색 염료 ',en:''},color:'#00ffff',size:2,},
        {idx:146,grade:4,display:146,na:{ko:'큰 분홍 염료',en:''},kg:0.2,price:1000,txt:{ko:'큰 분홍색 염료 ',en:''},color:'#ff00ff',size:2,},
        {idx:147,grade:4,display:147,na:{ko:'큰 자주 염료',en:''},kg:0.2,price:1000,txt:{ko:'큰 자주색 염료 ',en:''},color:'#880088',size:2,},
        {idx:148,grade:4,display:148,na:{ko:'큰 녹 염료',en:''},kg:0.2,price:1000,txt:{ko:'큰 녹색 염료 ',en:''},color:'#008800',size:2,},
        {idx:149,grade:4,display:149,na:{ko:'큰 연두 염료',en:''},kg:0.2,price:1000,txt:{ko:'큰 연두색 염료 ',en:''},color:'#00ff00',size:2,},
        {idx:150,grade:4,display:150,na:{ko:'큰 노랑 염료',en:''},kg:0.2,price:1000,txt:{ko:'큰 노랑색 염료 ',en:''},color:'#ffff00',size:2,},
        {idx:151,grade:4,display:151,na:{ko:'큰 주황 염료',en:''},kg:0.2,price:1000,txt:{ko:'큰 주황색 염료 ',en:''},color:'#ff8800',size:2,},
        {idx:152,grade:4,display:152,na:{ko:'큰 빨강 염료',en:''},kg:0.2,price:1000,txt:{ko:'큰 빨강색 염료 ',en:''},color:'#ff0000',size:2,},
        {idx:153,grade:4,display:153,na:{ko:'큰 보라 염료',en:''},kg:0.2,price:1000,txt:{ko:'큰 보라색 염료 ',en:''},color:'#8800ff',size:2,},
        {idx:154,grade:4,display:154,na:{ko:'큰 파랑 염료',en:''},kg:0.2,price:1000,txt:{ko:'큰 파랑색 염료 ',en:''},color:'#0000ff',size:2,},
        {idx:155,grade:4,display:155,na:{ko:'큰 군청 염료',en:''},kg:0.2,price:1000,txt:{ko:'큰 군청색 염료 ',en:''},color:'#000088',size:2,},
    ],
    upgrade:[//업그레이드 아이템
