export const items = {
    ...
    etc:[
        ...
        '','','','','','','',
        {idx:30,grade:1,imgCate:'itemEtc',displayText:'小',display:24,na:{ko:'소형 선박 설계도',en:''},price:100,action:0,invenUse:false,txt:{ko:'소형 선박을 제조 할 수 있는 설계도.',en:''},kg:0.1,eff:['?']},
        {idx:31,grade:2,imgCate:'itemEtc',displayText:'中',display:24,na:{ko:'중형 선박 설계도',en:''},price:100,action:0,invenUse:false,txt:{ko:'중형 선박을 제조 할 수 있는 설계도.',en:''},kg:0.1,eff:['?']},
        {idx:32,grade:3,imgCate:'itemEtc',displayText:'大',display:24,na:{ko:'대형 선박 설계도',en:''},price:100,action:0,invenUse:false,txt:{ko:'대형 선박을 제조 할 수 있는 설계도.',en:''},kg:0.1,eff:['?']},
        '','',
        {idx:35,grade:1,imgCate:'itemEtc',displayText:'I',display:25,na:{ko:'동물 선수상 설계도',en:''},price:100,action:0,invenUse:false,txt:{ko:'동물 선수상을 제조 할 수 있는 설계도.',en:''},kg:0.1,eff:['?']},
        {idx:36,grade:2,imgCate:'itemEtc',displayText:'II',display:25,na:{ko:'위인 선수상 설계도',en:''},price:100,action:0,invenUse:false,txt:{ko:'위인 선수상을 제조 할 수 있는 설계도.',en:''},kg:0.1,eff:['?']},
        {idx:37,grade:3,imgCate:'itemEtc',displayText:'III',display:25,na:{ko:'용 선수상 설계도',en:''},price:100,action:0,invenUse:false,txt:{ko:'용 선수상을 제조 할 수 있는 설계도.',en:''},kg:0.1,eff:['?']},
    ]
}