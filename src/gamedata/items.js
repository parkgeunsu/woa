export const items = {
    ...
    //enhance 강화
        1:[
            ...
            {idx:2,part:1,grade:1,display:10,na:'스컬 캡',kg:3,price:400,color:["#fff","#000"],socket:3,txt:'Skull Cap 반구형 형태의 철제 투구',eff:[{type:4,num:['50','100']}],set:0},
            {idx:3,part:1,grade:1,display:2,na:'코니컬 헬름',kg:5,price:500,color:["#fff","#000"],socket:3,txt:'Conical Helm 원뿔형태의 철제 투구',eff:[{type:4,num:['100','150']}],set:0},
            ...
            {idx:5,part:1,grade:1,display:9,na:'본 헬름',kg:6,price:400,color:["#fff","#58595B"],socket:3,txt:'Bone helm 짐승의 뼈로 만든 투구',eff:[{type:4,num:['100','300']}],set:0},
            {idx:6,part:1,grade:1,display:6,na:'헤럴드리 헬름',kg:14,price:1500,color:["#fff","#000"],socket:3,txt:'Heraldry Helm 폐쇠형 강철 투구',eff:[{type:4,num:['200','350']}],set:0},
            {idx:7,part:1,grade:1,display:8,na:'그레이트 헬름',kg:25,price:2000,color:["#fff","#000","#AF8C4F"],socket:3,txt:'Great Helm 우수한 방어효과 만큼 무거운 투구',eff:[{type:4,num:['350','500']}],set:0},
        ...
        2:[
            {idx:0,part:2,grade:1,display:20,na:'클로스 클로시즈',kg:1,price:100,color:["#F57E20"],socket:3,txt:'Cloth Clothes 천으로 만든 가벼운 옷, 천옷',eff:[{type:4,num:['5','50']}],set:0},
            ...
            {idx:2,part:2,grade:1,display:22,na:'하이드 아머',kg:7,price:400,color:["#C16F2B"],socket:3,txt:'Hide Armor 조끼형태의 가죽 갑옷',eff:[{type:4,num:['30','120']}],set:0},
            ...
            {idx:4,part:2,grade:1,display:24,na:'스터디드 레더 아머',kg:5,price:700,color:["#E4AF51"],socket:3,txt:'Studded Lether Armor 징박힌 가죽 갑옷',eff:[{type:4,num:['100','200']}],set:0},
            ...
            {idx:6,part:2,grade:1,display:26,na:'스케일 메일',kg:13,price:1000,color:["#E6E7E8"],socket:3,txt:'Scale Mail 금속조각을 붙힌 갑옷, 어린갑',eff:[{type:4,num:['170','270']}],set:0},
            {idx:7,part:2,grade:1,display:27,na:'체인 메일',kg:15,price:1000,color:["#fff"],socket:3,txt:'Chain Mail 메쉬형태로 금속링을 엮은 갑옷, 쇄자갑',eff:[{type:4,num:['200','300']}],set:0},
            {idx:8,part:2,grade:1,display:28,na:'스피린트 메일',kg:17,price:1100,color:["#9B8579"],socket:3,txt:'Splint Mail 천이나 가죽에 금속 스트립을 엮은 갑옷, 경번갑',eff:[{type:4,num:['250','400']}],set:0},
            {idx:9,part:2,grade:1,display:29,na:'브리간딘',kg:20,price:1200,color:["#D1D3D4"],socket:3,txt:'Brigandine 가죽 겉 감 안에 철판을 덧댄 갑옷,두정갑',eff:[{type:4,num:['300','450']}],set:0},
            {idx:10,part:2,grade:1,display:30,na:'플레이트 메일',kg:27,price:1500,color:["#000"],socket:3,txt:'Plate Mail 강철판으로 만든 갑옷, 판금갑',eff:[{type:4,num:['450','600']}],set:0},
            {idx:11,part:2,grade:1,display:31,na:'풀 플레이트',kg:35,price:2000,color:["#fff"],socket:3,txt:'Full Plate 전신을 강철판으로 만든 갑옷, 판금갑',eff:[{type:4,num:['600','1000']}],set:0},
        ]
