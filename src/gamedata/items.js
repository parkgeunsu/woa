export const items = {
    ...
    hole:[//홀 장착 아이템
        ...
        {idx:1,grade:1,imgCate:'itemHole',display:1,na:{ko:'큰 다이아몬드',en:''},color:'rgba(255,255,255,.8)',kg:0.1,price:100,txt:{ko:'마력이 깃든 돌',en:''},action:9,eff:[{type:4,num:['30']}]},//
        {idx:2,grade:2,imgCate:'itemHole',display:2,na:{ko:'다이아몬드',en:''},color:'rgba(255,255,255,.6)',kg:0.2,price:200,txt:{ko:'마력이 깃든 돌',en:''},action:9,eff:[{type:4,num:['20']}]},
        {idx:3,grade:3,imgCate:'itemHole',display:3,na:{ko:'작은 다이아몬드',en:''},color:'rgba(255,255,255,.4)',kg:0.4,price:400,txt:{ko:'마력이 깃든 돌',en:''},action:9,eff:[{type:4,num:['10']}]},
        {idx:4,grade:4,imgCate:'itemHole',display:4,na:{ko:'큰 에메랄드',en:''},color:'rgba(0,255,0,.8)',kg:0.7,price:1000,txt:{ko:'마력이 깃든 돌',en:''},action:9,eff:[{type:0,num:['30']}]},
        {idx:5,grade:1,imgCate:'itemHole',display:5,na:{ko:'에메랄드',en:''},color:'rgba(0,255,0,.6)',kg:0.1,price:100,txt:{ko:'마력이 깃든 돌',en:''},action:9,eff:[{type:0,num:['20']}]},//HP
        {idx:6,grade:2,imgCate:'itemHole',display:6,na:{ko:'작은 에메랄드',en:''},color:'rgba(0,255,0,.4)',kg:0.2,price:200,txt:{ko:'마력이 깃든 돌',en:''},action:9,eff:[{type:0,num:['10']}]},
        {idx:7,grade:3,imgCate:'itemHole',display:7,na:{ko:'큰 토파즈',en:''},color:'rgba(255,255,0,.8)',kg:0.4,price:400,txt:{ko:'마력이 깃든 돌',en:''},action:9,eff:[{type:6,num:['30']}]},
        {idx:8,grade:4,imgCate:'itemHole',display:8,na:{ko:'토파즈',en:''},color:'rgba(255,255,0,.6)',kg:0.7,price:1000,txt:{ko:'마력이 깃든 돌',en:''},action:9,eff:[{type:6,num:['20']}]},
        {idx:9,grade:1,imgCate:'itemHole',display:9,na:{ko:'작은 토파즈',en:''},color:'rgba(255,255,0,.4)',kg:0.1,price:100,txt:{ko:'마력이 깃든 돌',en:''},action:9,eff:[{type:6,num:['10']}]},//공
        {idx:10,grade:2,imgCate:'itemHole',display:10,na:{ko:'큰 루비',en:''},color:'rgba(255,0,0,.8)',kg:0.2,price:200,txt:{ko:'마력이 깃든 돌',en:''},action:9,eff:[{type:3,num:['30']}]},
        {idx:11,grade:3,imgCate:'itemHole',display:11,na:{ko:'루비',en:''},color:'rgba(255,0,0,.6)',kg:0.4,price:400,txt:{ko:'마력이 깃든 돌',en:''},action:9,eff:[{type:3,num:['20']}]},
        {idx:12,grade:4,imgCate:'itemHole',display:12,na:{ko:'작은 루비',en:''},color:'rgba(255,0,0,.4)',kg:0.7,price:1000,txt:{ko:'마력이 깃든 돌',en:''},action:9,eff:[{type:3,num:['10']}]},
        {idx:13,grade:1,imgCate:'itemHole',display:13,na:{ko:'큰 자수정',en:''},color:'rgba(255,0,255,.8)',kg:0.1,price:100,txt:{ko:'마력이 깃든 돌',en:''},action:9,eff:[{type:5,num:['30']}]},//방
        {idx:14,grade:2,imgCate:'itemHole',display:14,na:{ko:'자수정',en:''},color:'rgba(255,0,255,.6)',kg:0.2,price:200,txt:{ko:'마력이 깃든 돌',en:''},action:9,eff:[{type:5,num:['20']}]},
        {idx:15,grade:3,imgCate:'itemHole',display:15,na:{ko:'작은 자수정',en:''},color:'rgba(255,0,255,.4)',kg:0.4,price:400,txt:{ko:'마력이 깃든 돌',en:''},action:9,eff:[{type:5,num:['10']}]},'','','','','',
        '','','','','','','','','','',
        '','','','','','','','','','',
        '','','','','','','','','','',
        '','','','','','','','','','',
        ...
        '','','','','','','','','','',
        '','','','','','','','','','',
        {idx:101,grade:2,imgCate:'itemHole',display:101,na:{ko:'작은 백 염료',en:''},kg:0.1,price:1000,txt:{ko:'작은 백색 염료 ',en:''},color:'rgba(255,255,255,.4)',size:0,eff:[{type:21,num:['3']}]},
        {idx:102,grade:2,imgCate:'itemHole',display:102,na:{ko:'작은 흑 염료',en:''},kg:0.1,price:1000,txt:{ko:'작은 흑색 염료 ',en:''},color:'rgba(0,0,0,.4)',size:0,eff:[{type:22,num:['3']}]},
        {idx:103,grade:2,imgCate:'itemHole',display:103,na:{ko:'작은 청록 염료',en:''},kg:0.1,price:1000,txt:{ko:'작은 청록색 염료 ',en:''},color:'rgba(0,137,137,.4)',size:0,eff:[{type:0,num:['25']}]},
        {idx:104,grade:2,imgCate:'itemHole',display:104,na:{ko:'작은 카키 염료',en:''},kg:0.1,price:1000,txt:{ko:'작은 카키색 염료 ',en:''},color:'rgba(137,137,0,.4)',size:0,eff:[{type:21,num:['1']},{type:22,num:['1']}]},
        {idx:105,grade:2,imgCate:'itemHole',display:105,na:{ko:'작은 하늘 염료',en:''},kg:0.1,price:1000,txt:{ko:'작은 하늘색 염료 ',en:''},color:'rgba(0,255,255,.4)',size:0,eff:[{type:25,num:['3']}]},
        {idx:106,grade:2,imgCate:'itemHole',display:106,na:{ko:'작은 분홍 염료',en:''},kg:0.1,price:1000,txt:{ko:'작은 분홍색 염료 ',en:''},color:'rgba(255,0,255,.4)',size:0,eff:[{type:23,num:['1']},{type:24,num:['1']},{type:25,num:['1']},{type:26,num:['1']}]},
        {idx:107,grade:2,imgCate:'itemHole',display:107,na:{ko:'작은 자주 염료',en:''},kg:0.1,price:1000,txt:{ko:'작은 자주색 염료 ',en:''},color:'rgba(137,0,137,.4)',size:0,eff:[{type:8,num:['3']}]},
        {idx:108,grade:2,imgCate:'itemHole',display:108,na:{ko:'작은 녹 염료',en:''},kg:0.1,price:1000,txt:{ko:'작은 녹색색 염료 ',en:''},color:'rgba(0,137,0,.4)',size:0,eff:[{type:4,num:['15']}]},
        {idx:109,grade:2,imgCate:'itemHole',display:109,na:{ko:'작은 연두 염료',en:''},kg:0.1,price:1000,txt:{ko:'작은 연두색 염료 ',en:''},color:'rgba(0,255,0,.4)',size:0,eff:[{type:26,num:['3']}]},
        {idx:110,grade:2,imgCate:'itemHole',display:110,na:{ko:'작은 노랑 염료',en:''},kg:0.1,price:1000,txt:{ko:'작은 노랑색 염료 ',en:''},color:'rgba(255,255,0,.4)',size:0,eff:[{type:9,num:['3']}]},
        {idx:111,grade:2,imgCate:'itemHole',display:111,na:{ko:'작은 주황 염료',en:''},kg:0.1,price:1000,txt:{ko:'작은 주황색 염료 ',en:''},color:'rgba(255,137,0,.4)',size:0,eff:[{type:3,num:['15']}]},
        {idx:112,grade:2,imgCate:'itemHole',display:112,na:{ko:'작은 빨강 염료',en:''},kg:0.1,price:1000,txt:{ko:'작은 빨강색 염료 ',en:''},color:'rgba(255,0,0,.4)',size:0,eff:[{type:24,num:['3']}]},
        {idx:113,grade:2,imgCate:'itemHole',display:113,na:{ko:'작은 보라 염료',en:''},kg:0.1,price:1000,txt:{ko:'작은 보라색 염료 ',en:''},color:'rgba(137,0,255,.4)',size:0,eff:[{type:6,num:['15']}]},
        {idx:114,grade:2,imgCate:'itemHole',display:114,na:{ko:'작은 파랑 염료',en:''},kg:0.1,price:1000,txt:{ko:'작은 파랑색 염료 ',en:''},color:'rgba(0,0,255,.4)',size:0,eff:[{type:23,num:['3']}]},
        {idx:115,grade:2,imgCate:'itemHole',display:115,na:{ko:'작은 군청 염료',en:''},kg:0.1,price:1000,txt:{ko:'작은 군청색 염료 ',en:''},color:'rgba(0,0,137,.4)',size:0,eff:[{type:5,num:['15']}]},
        '','','','','',
        {idx:121,grade:3,imgCate:'itemHole',display:121,na:{ko:'백 염료',en:''},kg:0.1,price:1000,txt:{ko:'백색 염료 ',en:''},color:'rgba(255,255,255,.6)',size:1,eff:[{type:21,num:['7']}]},
        {idx:122,grade:3,imgCate:'itemHole',display:122,na:{ko:'흑 염료',en:''},kg:0.1,price:1000,txt:{ko:'흑색 염료 ',en:''},color:'rgba(0,0,0,.6)',size:1,eff:[{type:22,num:['7']}]},
        {idx:123,grade:3,imgCate:'itemHole',display:123,na:{ko:'청록 염료',en:''},kg:0.1,price:1000,txt:{ko:'청록색 염료 ',en:''},color:'rgba(0,137,137,.6)',size:1,eff:[{type:0,num:['50']}]},
        {idx:124,grade:3,imgCate:'itemHole',display:124,na:{ko:'카키 염료',en:''},kg:0.1,price:1000,txt:{ko:'카키색 염료 ',en:''},color:'rgba(137,137,0,.6)',size:1,eff:[{type:21,num:['2']},{type:22,num:['2']}]},
        {idx:125,grade:3,imgCate:'itemHole',display:125,na:{ko:'하늘 염료',en:''},kg:0.1,price:1000,txt:{ko:'하늘색 염료 ',en:''},color:'rgba(0,255,255,.6)',size:1,eff:[{type:25,num:['7']}]},
        {idx:126,grade:3,imgCate:'itemHole',display:126,na:{ko:'분홍 염료',en:''},kg:0.1,price:1000,txt:{ko:'분홍색 염료 ',en:''},color:'rgba(255,0,255,.6)',size:1,eff:[{type:23,num:['2']},{type:24,num:['2']},{type:25,num:['2']},{type:26,num:['2']}]},
        {idx:127,grade:3,imgCate:'itemHole',display:127,na:{ko:'자주 염료',en:''},kg:0.1,price:1000,txt:{ko:'자주색 염료 ',en:''},color:'rgba(137,0,137,.6)',size:1,eff:[{type:8,num:['7']}]},
        {idx:128,grade:3,imgCate:'itemHole',display:128,na:{ko:'녹 염료',en:''},kg:0.1,price:1000,txt:{ko:'녹색 염료 ',en:''},color:'rgba(0,137,0,.6)',size:1,eff:[{type:4,num:['30']}]},
        {idx:129,grade:3,imgCate:'itemHole',display:129,na:{ko:'연두 염료',en:''},kg:0.1,price:1000,txt:{ko:'연두색 염료 ',en:''},color:'rgba(0,255,0,.6)',size:1,eff:[{type:26,num:['7']}]},
        {idx:130,grade:3,imgCate:'itemHole',display:130,na:{ko:'노랑 염료',en:''},kg:0.1,price:1000,txt:{ko:'노랑색 염료 ',en:''},color:'rgba(255,255,0,.6)',size:1,eff:[{type:9,num:['7']}]},
        {idx:131,grade:3,imgCate:'itemHole',display:131,na:{ko:'주황 염료',en:''},kg:0.1,price:1000,txt:{ko:'주황색 염료 ',en:''},color:'rgba(255,137,0,.6)',size:1,eff:[{type:3,num:['30']}]},
        {idx:132,grade:3,imgCate:'itemHole',display:132,na:{ko:'빨강 염료',en:''},kg:0.1,price:1000,txt:{ko:'빨강색 염료 ',en:''},color:'rgba(255,0,0,.6)',size:1,eff:[{type:24,num:['7']}]},
        {idx:133,grade:3,imgCate:'itemHole',display:133,na:{ko:'보라 염료',en:''},kg:0.1,price:1000,txt:{ko:'보라색 염료 ',en:''},color:'rgba(137,0,255,.6)',size:1,eff:[{type:6,num:['30']}]},
        {idx:134,grade:3,imgCate:'itemHole',display:134,na:{ko:'파랑 염료',en:''},kg:0.1,price:1000,txt:{ko:'파랑색 염료 ',en:''},color:'rgba(0,0,255,.6)',size:1,eff:[{type:23,num:['7']}]},
        {idx:135,grade:3,imgCate:'itemHole',display:135,na:{ko:'군청 염료',en:''},kg:0.1,price:1000,txt:{ko:'군청색 염료 ',en:''},color:'rgba(0,0,137,.6)',size:1,eff:[{type:5,num:['30']}]},
        '','','','','',
        {idx:141,grade:4,imgCate:'itemHole',display:141,na:{ko:'큰 백 염료',en:''},kg:0.2,price:1000,txt:{ko:'큰 백색 염료 ',en:''},color:'rgba(255,255,255,.8)',size:2,eff:[{type:21,num:['10']}]},
        {idx:142,grade:4,imgCate:'itemHole',display:142,na:{ko:'큰 흑 염료',en:''},kg:0.2,price:1000,txt:{ko:'큰 흑색 염료 ',en:''},color:'rgba(0,0,0,.8)',size:2,eff:[{type:22,num:['10']}]},
        {idx:143,grade:4,imgCate:'itemHole',display:143,na:{ko:'큰 청록 염료',en:''},kg:0.2,price:1000,txt:{ko:'큰 청록색 염료 ',en:''},color:'rgba(0,137,137,.8)',size:2,eff:[{type:0,num:['75']}]},
        {idx:144,grade:4,imgCate:'itemHole',display:144,na:{ko:'큰 카키 염료',en:''},kg:0.2,price:1000,txt:{ko:'큰 카키색 염료 ',en:''},color:'rgba(137,137,0,.8)',size:2,eff:[{type:21,num:['3']},{type:22,num:['3']}]},
        {idx:145,grade:4,imgCate:'itemHole',display:145,na:{ko:'큰 하늘 염료',en:''},kg:0.2,price:1000,txt:{ko:'큰 하늘색 염료 ',en:''},color:'rgba(0,255,255,.8)',size:2,eff:[{type:25,num:['10']}]},
        {idx:146,grade:4,imgCate:'itemHole',display:146,na:{ko:'큰 분홍 염료',en:''},kg:0.2,price:1000,txt:{ko:'큰 분홍색 염료 ',en:''},color:'rgba(255,0,255,.8)',size:2,eff:[{type:23,num:['3']},{type:24,num:['3']},{type:25,num:['3']},{type:26,num:['3']}]},
        {idx:147,grade:4,imgCate:'itemHole',display:147,na:{ko:'큰 자주 염료',en:''},kg:0.2,price:1000,txt:{ko:'큰 자주색 염료 ',en:''},color:'rgba(137,0,137,.8)',size:2,eff:[{type:8,num:['10']}]},
        {idx:148,grade:4,imgCate:'itemHole',display:148,na:{ko:'큰 녹 염료',en:''},kg:0.2,price:1000,txt:{ko:'큰 녹색 염료 ',en:''},color:'rgba(0,137,0,.8)',size:2,eff:[{type:4,num:['50']}]},
        {idx:149,grade:4,imgCate:'itemHole',display:149,na:{ko:'큰 연두 염료',en:''},kg:0.2,price:1000,txt:{ko:'큰 연두색 염료 ',en:''},color:'rgba(0,255,0,.8)',size:2,eff:[{type:26,num:['10']}]},
        {idx:150,grade:4,imgCate:'itemHole',display:150,na:{ko:'큰 노랑 염료',en:''},kg:0.2,price:1000,txt:{ko:'큰 노랑색 염료 ',en:''},color:'rgba(255,255,0,.8)',size:2,eff:[{type:9,num:['10']}]},
        {idx:151,grade:4,imgCate:'itemHole',display:151,na:{ko:'큰 주황 염료',en:''},kg:0.2,price:1000,txt:{ko:'큰 주황색 염료 ',en:''},color:'rgba(255,137,0,.8)',size:2,eff:[{type:3,num:['50']}]},
        {idx:152,grade:4,imgCate:'itemHole',display:152,na:{ko:'큰 빨강 염료',en:''},kg:0.2,price:1000,txt:{ko:'큰 빨강색 염료 ',en:''},color:'rgba(255,0,0,.8)',size:2,eff:[{type:24,num:['10']}]},
        {idx:153,grade:4,imgCate:'itemHole',display:153,na:{ko:'큰 보라 염료',en:''},kg:0.2,price:1000,txt:{ko:'큰 보라색 염료 ',en:''},color:'rgba(137,0,255,.8)',size:2,eff:[{type:6,num:['50']}]},
        {idx:154,grade:4,imgCate:'itemHole',display:154,na:{ko:'큰 파랑 염료',en:''},kg:0.2,price:1000,txt:{ko:'큰 파랑색 염료 ',en:''},color:'rgba(0,0,255,.8)',size:2,eff:[{type:23,num:['10']}]},
        {idx:155,grade:4,imgCate:'itemHole',display:155,na:{ko:'큰 군청 염료',en:''},kg:0.2,price:1000,txt:{ko:'큰 군청색 염료 ',en:''},color:'rgba(0,0,137,.8)',size:2,eff:[{type:5,num:['50']}]},
    ],
    upgrade:[//업그레이드 아이템
