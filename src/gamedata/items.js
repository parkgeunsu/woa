...
export const items = {
  ...
  //enhance 강화
    1:[//모자
      [
        [//normal,magic,rare,epic
          ...
          {idx:6,part:1,grade:1,display:6,na:{ko:'헤럴드리 헬름',en:'Heraldry Helm',jp:'ヘラルド・ヘルム'},kg:14,price:1500,color:["#fff"],socket:3,txt:{ko:'폐쇄형 강철 투구',en:'A closed steel helmet',jp:'密閉型スチールヘルメット'},eff:[{type:4,num:['200','350']},{type:6,num:['200','300']}],actionType:"",requiredSlot:1,limit:[true,false,false,true,false,false,false,false,false,false,true,false,false,true,false,false,false,false],country:'',set:0},

          {idx:7,part:1,grade:1,display:8,na:{ko:'그레이트 헬름',en:'Great Helm',jp:'グレートヘルム'},kg:25,price:2000,color:["#fff","#AF8C4F"],socket:4,txt:{ko:'우수한 방어효과 만큼 무거운 투구',en:'Helm as heavy as a good defense',jp:'優れた防御効果と同じくらい重い兜'},eff:[{type:4,num:['350','500']},{type:6,num:['200','350']}],actionType:"",requiredSlot:1,limit:[true,false,false,true,false,false,false,false,false,false,true,false,false,true,false,false,false,false],country:'',set:0},
        ],
        [//unique
    ...
    2:[//갑옷
      [
        [//normal,magic,rare,epic
          ...
          {idx:5,part:2,grade:1,display:25,na:{ko:'링 메일',en:'Ring Mail',jp:'リングメール'},kg:11,price:1000,color:["#fff"],socket:3,txt:{ko:'사슬 형태의 철제 갑옷',en:'A chain of iron armor',jp:'チェーン型の鉄製の鎧'},eff:[{type:4,num:['150','250']},{type:6,num:['100','250']}],actionType:"",requiredSlot:1,limit:[true,true,true,true,false,false,false,false,false,true,true,true,false,true,true,false,true,true],country:'',set:0},
          ...
          {idx:8,part:2,grade:1,display:28,na:{ko:'스피린트 메일',en:'Splint Mail',jp:'スピリントメール'},kg:17,price:1500,color:["#9B8579"],socket:4,txt:{ko:'천이나 가죽에 금속 스트립을 엮은 갑옷, 경번갑',en:'A mesh-type metal ring of armor',jp:'布や革に金属片を編み込んだ鎧、軽装甲。'},eff:[{type:4,num:['250','400']},{type:6,num:['250','400']}],actionType:"",requiredSlot:1,limit:[true,true,true,true,false,false,false,false,false,true,true,true,false,true,true,false,true,false],country:'',set:0},
          ...
          {idx:11,part:2,grade:1,display:31,na:{ko:'풀 플레이트',en:'Full Plate',jp:'フルプレート'},kg:35,price:4000,color:["#fff"],socket:5,txt:{ko:'전신을 강철판으로 만든 갑옷, 판금갑',en:'Upgraded form of plate mail',jp:'全身を鉄板で作った鎧、板金甲冑。'},eff:[{type:4,num:['600','1000']},{type:6,num:['350','450']}],actionType:"",requiredSlot:1,limit:[true,false,false,true,false,false,false,false,false,false,true,false,false,true,false,false,false,false],country:'',set:0},
        ],
        [//unique
    ...
    3:[//무기
      ...
      [//검1
        [//normal,magic,rare,epic
          ...
          {idx:7,part:3,grade:1,display:97,na:{ko:'브로드소드',en:'Broad Sword',jp:'ブロードソード'},kg:1.6,price:1000,color:["#ffffff", "#A5A4A4"],socket:2,txt:{ko:'중국의 도(刀, Dao)를 영어로 번역할 때 브로드소드라고 하는 경우도 종종 있다.',en:'When translating the Chinese Dao into English, it is often referred to as a broadsword.',jp:'中国の刀(刀、Dao)を英語に翻訳する際、ブロードソードと呼ばれることもしばしばある。'},eff:[{type:3,num:['250','350']},{type:5,num:['1','100']}],actionType:[1],requiredSlot:1,limit:[true,true,true,true,true,true,false,true,true,true,true,true,false,true,true,true,false,true],country:'',set:0},
      ...
      [//양손검2
        [//normal,magic,rare,epic
          {idx:0,part:3,grade:1,display:120,na:{ko:'월도',en:'Moon Blade',jp:'月刀'},kg:2.5,price:1000,color:["#ffffff","#3C2415"],socket:5,txt:{ko:'월도는 외날에 긴 자루를 가진 도(刀) 계열의 무기를 일컫는다.',en:'A moon sword is a weapon of the sword family that has a long hilt on the outer edge.',jp:'月刀は、片刃に長い柄を持つ刀(刀)系の武器を指す。'},eff:[{type:3,num:['200','300']},{type:5,num:['150','200']}],actionType:[1],requiredSlot:2,limit:[true,false,true,true,false,false,false,false,false,false,true,true,false,true,false,false,false,false],country:'',set:0},

          {idx:1,part:3,grade:1,display:121,na:{ko:'나기나타',en:'Oriental Glaive',jp:'ナギナタ'},kg:3,price:1000,color:["#ffffff","#FBB040"],socket:4,txt:{ko:'일본 헤이안 시대부터 쓰이기 시작한 전근대 장병도 계열 무기이며, 장병기의 일종이다.',en:'It is a pre-modern longsword-like weapon from the Heian period in Japan, and is a type of longsword.',jp:'日本の平安時代から使われ始めた前近代長柄刀系の武器で、長柄刀の一種である。'},eff:[{type:3,num:['250','350']},{type:5,num:['100','150']}],actionType:[1],requiredSlot:2,limit:[true,false,true,true,false,false,false,false,false,false,true,true,false,true,false,false,false,false],country:'',set:0},

          {idx:2,part:3,grade:1,display:122,na:{ko:'롱소드',en:'Long Sword',jp:'ロングソード'},kg:3,price:1000,color:["#ffffff"],socket:4,txt:{ko:'유럽에서 쓰인 양날 양손 도검이다.',en:'A double-edged, two-handed sword used in Europe.',jp:'ヨーロッパで使われた両刃の両手剣です。'},eff:[{type:3,num:['250','350']},{type:5,num:['50','200']}],actionType:[1],requiredSlot:2,limit:[true,false,true,true,false,false,false,false,false,false,true,true,false,true,false,false,false,false],country:'',set:0},

          {idx:3,part:3,grade:1,display:123,na:{ko:'바스타드소드',en:'Bastard Sword',jp:'バスタードソード'},kg:4,price:1500,color:["#ffffff"],socket:5,txt:{ko:'폭의 변화가 매우 큰(테이퍼진) 검신을 지닌 롱소드.',en:'A longsword with a very wide (tapered) hilt.',jp:'幅の変化が非常に大きい(テーパード)剣身を持つロングソード。'},eff:[{type:3,num:['300','600']},{type:5,num:['10','100']}],actionType:[1],requiredSlot:2,limit:[true,false,true,true,false,false,false,false,false,false,true,true,false,true,false,false,false,false],country:'',set:0},

          {idx:4,part:3,grade:1,display:124,na:{ko:'그레이트소드',en:'Great Sword'},kg:4,price:1500,color:["#ffffff","#831529"],socket:4,txt:{ko:'그레이트소드는 말 그대로 대검이라는 의미. 대검이라는 것 외에 단어가 특정짓는 특징은 없다.',en:'',jp:''},eff:[{type:3,num:['250','550']},{type:5,num:['10','120']}],actionType:[1],requiredSlot:2,limit:[true,false,true,true,false,false,false,false,false,false,true,true,false,true,false,false,false,false],country:'',set:0},

          {idx:5,part:3,grade:1,display:125,na:{ko:'익시큐셔너소드',en:'Executioner Sword',jp:'エクスキューショナーソード'},kg:5,price:1700,color:["#ffffff","#FBB040","#754C29"],socket:5,txt:{ko:'이름 그대로 사형집행인들이 죄인을 참수형에 처할때 쓰기 위해 특별히 만들어진 도검이다.',en:'As the name suggests, it is a sword made specifically for executioners to behead criminals.',jp:'その名の通り、死刑執行人が罪人を斬首するときに使うために特別に作られた刀だ。'},eff:[{type:3,num:['300','500']}],actionType:[1],requiredSlot:2,limit:[true,false,true,true,false,false,false,false,false,false,true,true,false,true,false,false,false,false],country:'',set:0},

          {idx:6,part:3,grade:1,display:126,na:{ko:'츠바이헨더',en:'Zweihänder',jp:'ツヴァイヘンダー'},kg:7,price:3000,color:["#ffffff","#FBB040","#754C29"],socket:6,txt:{ko:'르네상스 시대, 16세기경에 주로 사용된 독일제 트루 투핸더를 말한다.',en:'A German-made true two-hander used primarily during the Renaissance, around the 16th century.',jp:'ルネッサンス時代、16世紀頃に主に使用されたドイツ製トゥーハンダーのこと。'},eff:[{type:3,num:['300','700']},{type:5,num:['10','150']}],actionType:[1],requiredSlot:2,limit:[true,false,true,true,false,false,false,false,false,false,true,true,false,true,false,false,false,false],country:'',set:0},

          {idx:7,part:3,grade:1,display:127,na:{ko:'클레이모어',en:'Claymore',jp:'クレイモア'},kg:5.5,price:2500,color:["#ffffff","#831529"],socket:5,txt:{ko:'15세기에서 17세기까지 스코틀랜드의 하이랜더들이 사용한 것으로 유명하다.',en:'It was famously used by the Highlanders of Scotland from the 15th to the 17th century.',jp:'15世紀から17世紀にかけてスコットランドのハイランダーが使用したことで有名。'},eff:[{type:3,num:['350','450']},{type:5,num:['10','250']}],actionType:[1],requiredSlot:2,limit:[true,false,true,true,false,false,false,false,false,false,true,true,false,true,false,false,false,false],country:'',set:0},
      ...
      [//창4
        [//normal,magic,rare,epic
          {idx:0,part:3,grade:1,display:180,na:{ko:'극',en:'Oriental Polearm',jp:'戟'},kg:3.5,price:1500,color:["#ffffff"],socket:5,txt:{ko:'중국의 고대 폴암으로 긴 손잡이 끝에 단검이 붙었고 그보다 조금 밑에 보조날이 달린 무기.',en:'An ancient Chinese polearm with a dagger attached to the end of the long handle and a secondary blade slightly below it.',jp:'中国の古代ポールアームで、長い柄の先に短剣がつき、その少し下に補助刃が付いた武器。'},eff:[{type:3,num:['100','450']},{type:5,num:['450','450']}],actionType:[0],requiredSlot:2,limit:[true,false,true,true,false,false,false,false,false,false,true,false,true,true,true,false,false,false],country:'',set:0},

          {idx:1,part:3,grade:1,display:181,na:{ko:'랜스',en:'Lance',jp:'ランス'},kg:4,price:1200,color:["#ffffff","#BCBEC0"],socket:6,txt:{ko:'거대한 원뿔형태를 한 창으로, 손으로 겨누고 겨드랑이로 고정할 수 있도록 뒷부분이 짧게 설계되어 있다.',en:'It\'s a giant cone-shaped spear, with a short back end that allows you to aim it with your hand and hold it in your armpit.',jp:'巨大な円錐形をした槍で、手で向けて脇の下で固定できるように後部が短く設計されている。'},eff:[{type:3,num:['50','500']},{type:5,num:['500','500']}],actionType:[0],requiredSlot:2,limit:[true,false,true,true,false,false,false,false,false,false,true,false,true,true,true,false,false,false],country:'',set:0},
          ...
          {idx:3,part:3,grade:1,display:183,na:{ko:'빌',en:'Bill',jp:'ビル'},kg:3,price:1300,color:["#ffffff"],socket:4,txt:{ko:'유럽에서 사용하던 것으로 농기구에서 먼저 발전해 전쟁사에 이름이 등장하며 영국에서는 ‘무기를 들고 일어서라’라는 의미인 ‘활과 창’을 의미한다.',en:'Used in Europe, it evolved first as a farming tool, and its name appears in the history of warfare, where it means "bow and spear" in English, meaning "to take up arms".',jp:'ヨーロッパで使われていたもので、農具から先に発展し、戦争史に名前が登場し、イギリスでは「武器を持って立ち上がれ」という意味の「弓と槍」を意味します。'},eff:[{type:3,num:['50','400']},{type:5,num:['400','400']}],actionType:[0],requiredSlot:2,limit:[true,false,true,true,false,false,false,false,false,false,true,false,true,true,true,false,false,false],country:'',set:0},

          {idx:4,part:3,grade:1,display:184,na:{ko:'파르티잔',en:'Partisan',jp:'パルティザン'},kg:2.5,price:1000,color:["#ffffff"],socket:5,txt:{ko:'날의 평평한 부분에는 조각이나 투각같은 장식이 새겨져 있고 사용자의 상황에 따라 베고 찌를수 있도록 디자인이 되었다.',en:'The flat part of the blade is decorated with carvings or engravings and is designed to slash and stab depending on the user\'s situation.',jp:'刃の平らな部分には彫刻や透かし彫りのような装飾が施され、ユーザーの状況に応じて斬ったり刺したりできるようにデザインされています。'},eff:[{type:3,num:['10','450']},{type:5,num:['450','450']},{type:9,num:['1','10']}],actionType:[0],requiredSlot:2,limit:[true,false,true,true,false,false,false,false,false,false,true,false,true,true,true,false,false,false],country:'',set:0},
      ...
      [//타격7
        [//normal,magic,rare,epic
          ...
          {idx:2,part:3,grade:1,display:252,na:{ko:'너클',en:'Knuckle',jp:'ナックル'},kg:0.5,price:500,color:["#939598","#000000"],socket:4,txt:{ko:'뾰족한 돌기가 있는 금속의 맨손무기.',en:'A metal, bare weapon with a sharp point.',jp:'尖った突起のある金属の素手武器。'},eff:[{type:3,num:['50','150']},{type:5,num:['50','150']}],actionType:[3],requiredSlot:1,limit:[true,false,false,false,true,true,true,true,true,true,true,true,true,true,true,false,true,true],country:'',set:0},
          
          {idx:3,part:3,grade:1,display:253,na:{ko:'철선',en:'Iron Fan',jp:'鐵扇'},kg:0.3,price:500,color:["#ffffff"],socket:4,txt:{ko:'쇠로 만든 부채.',en:'A fan made of iron.',jp:'鉄製の扇子。'},eff:[{type:3,num:['1','111']}],actionType:[5],requiredSlot:1,limit:[true,false,false,false,false,false,true,true,true,true,true,true,true,true,false,false,false,false],country:'',set:0},
        ],
        [//unique
        ],
        [//legend
      ...
      [//방패8
        [//normal,magic,rare,epic
          ...
          {idx:4,part:3,grade:1,display:274,na:{ko:'히터실드',en:'Heater Shield',jp:'ヒーターシールド'},kg:6.5,price:1200,color:["#3F6731","#EE1C4E","#FEEB00"],socket:4,txt:{ko:'10세기 중엽부터 등장한 외형은 카이트 실드의 위아래를 짧게 자른듯한 축소형 중세 유럽의 방패.',en:'A scaled-down medieval European shield from the mid-10th century that looks like a shortened version of the top and bottom of a kite shield.',jp:'10世紀中頃から登場した外観は、カイトシールドの上下を短く切ったような縮小型の中世ヨーロッパの盾。'},eff:[{type:4,num:['200','300']},{type:6,num:['150','200']}],actionType:"",requiredSlot:1,limit:[true,false,true,false,true,false,false,false,false,true,true,true,false,true,false,false,true,false],country:'',set:0},

          {idx:5,part:3,grade:1,display:275,na:{ko:'스쿠툼',en:'Scutum',jp:'スクトゥーム'},kg:8,price:1500,color:["#939598","#000000"],socket:4,txt:{ko:'목제 방패로, 타원형과 직사각형 모양의 로마군이 장비한 제식 방패.',en:'Wooden shield, ceremonial shield equipped by Roman soldiers in oval and rectangular shapes.',jp:'木製の盾で、楕円形や長方形の形をしたローマ軍が装備した制式盾。'},eff:[{type:4,num:['300','400']},{type:6,num:['200','300']}],actionType:"",requiredSlot:1,limit:[true,false,true,false,true,false,false,false,false,true,true,true,false,true,false,false,true,false],country:'',set:0},
          
          {idx:6,part:3,grade:1,display:276,na:{ko:'파비스',en:'Pavise',jp:'ファビス'},kg:8,price:1500,color:["#939598","#000000","#19469B"],socket:4,txt:{ko:'중세 유럽의 전쟁에서 궁병이나 쇠뇌병들이 사용한 대형방패.',en:'A large shield used by archers and crossbowmen in medieval European warfare.',jp:'中世ヨーロッパの戦争で弓兵や弩兵が使用した大型盾。'},eff:[{type:4,num:['200','350']},{type:6,num:['200','350']}],actionType:"",requiredSlot:1,limit:[true,false,true,false,true,false,false,false,false,true,true,true,false,true,false,false,true,false],country:'',set:0},
        ],
        [//unique
        ],
        [//legend
    ...
    4:[//반지
      [
        [//normal,magic,rare,epic
          {idx:0,part:4,grade:1,display:290,na:{ko:'반지',en:'Ring',jp:'リング'},kg:0.1,price:1000,color:["#F9B919"],socket:1,txt:{ko:'손가락에 끼는 악세사리.',en:'An accessory that fits on your finger.',jp:'指にはめるアクセサリー。'},eff:[],actionType:"",requiredSlot:1,limit:[true,true,true,true,true,true,true,true,true,true,true,true,true,true,true,true,true,true],country:'',set:0},

          {idx:1,part:4,grade:1,display:291,na:{ko:'진주 반지',en:'Pearl Ring',jp:'パールリング'},kg:0.1,price:2000,color:["#F9B919","#000000"],socket:1,txt:{ko:'손가락에 끼우는 악세사리. 진주로 장식되어 있음',en:'An accessory worn on the finger. Decorated with pearls',jp:'指にはめるアクセサリー。パールで飾られている'},eff:[],actionType:"",requiredSlot:1,limit:[true,true,true,true,true,true,true,true,true,true,true,true,true,true,true,true,true,true],country:'',set:0},

          {idx:2,part:4,grade:1,display:292,na:{ko:'뼈 반지',en:'Bone Ring',jp:'ボーンリング'},kg:0.1,price:5000,color:["#F9B919","#000000"],socket:1,txt:{ko:'손가락에 끼우는 악세사리. 뼈로 장식되어 있음',en:'An accessory worn on the finger. Decorated with bones',jp:'指にはめるアクセサリー。骨の装飾が施されている'},eff:[],actionType:"",requiredSlot:1,limit:[true,true,true,true,true,true,true,true,true,true,true,true,true,true,true,true,true,true],country:'',set:0},
        ],
        [//unique
        ],
        [//legend
