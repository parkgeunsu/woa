...
export const items = {
  ...
  etc:[
    ...
    {idx:22,grade:1,imgCate:'itemEtc',display:28,na:{ko:'보석제거 집게',en:'Jewelry Removal Pincers',jp:'宝石除去用トング'},price:100,action:'',invenUse:false,txt:{ko:'아이템에 박힌 보석을 제거 할 수 있다.',en:'',jp:''},kg:0.3,eff:['?']},

    {idx:23,grade:1,imgCate:'itemEtc',display:29,na:{ko:'보물지도',en:'Treasure Map',jp:'宝の地図'},price:100,action:'',invenUse:false,txt:{ko:'보물이 숨겨진 장소를 알 수 있다.',en:'You know where the treasure is hidden.',jp:'宝物が隠された場所を知ることができる。'},kg:0.3,eff:['?']},

    {idx:24,grade:1,imgCate:'itemEtc',display:30,na:{ko:'보물지도 조각',en:'Treasure Map Fragments',jp:'宝の地図の彫刻'},price:100,action:'',invenUse:false,txt:{ko:'10개를 합치면 보물지도를 만들 수 있다.',en:'Combine 10 of them to create a treasure map.',jp:'10個合わせると宝の地図を作ることができる。'},kg:0.3,eff:['?']},
    {idx:25,grade:4,imgCate:'itemEtc',display:30,na:{ko:'보물지도 조각',en:'Treasure Map Fragments',jp:'宝の地図の彫刻'},price:100,action:'',invenUse:false,txt:{ko:'10개를 합치면 보물지도를 만들 수 있다.',en:'Combine 10 of them to create a treasure map.',jp:'10個合わせると宝の地図を作ることができる。'},kg:0.3,eff:['?']},
    '','','','','',
