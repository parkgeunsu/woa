...
const ItemEnhance = styled.div`
  ...
  &{
    ...
    .hole_item .item_lv{position:absolute;left:0;top:0;padding:5px;z-index:2;background:rgba(0,0,0,.5);text-align:left;font-size:14px;font-weight:600;}
    .hole_item .item_name{margin:2px 0 5px 0;font-weight:600;color:#fff;font-size:12px;text-align:center;}
