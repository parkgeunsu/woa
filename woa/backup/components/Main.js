    ...
    <>
      <ContentMainWarp className="main_wrap">
        <ContentMenu className="main_menu transition">
          <ul className="menu">
            <li><Link to="/character" onClick={() => {changePage("character");}}>Character</Link></li>
            <li><Link to="/gacha" onClick={() => {changePage("gacha");}}>Gacha</Link></li>
            <li><Link to="/lineup" onClick={() => {changePage("lineup");}}>Lineup</Link></li>
            <li><Link to="/battle" onClick={() => {changePage("battle");}}>Battle</Link></li>
          </ul>
        </ContentMenu>
      </ContentMainWarp>
    </>
